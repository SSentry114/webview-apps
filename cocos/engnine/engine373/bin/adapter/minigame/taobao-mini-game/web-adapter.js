...
$global.screencanvas = $global.screencanvas || new CanvasProxy(); // NOTE: this is a hack operation
...
if (window.__globalAdapter) {
  ...
  utils.cloneMethod(globalAdapter, my, 'onTouchCancel'); // Audio
  ...
  utils.cloneMethod(globalAdapter, my, 'onAudioInterruptionBegin'); // Video

  utils.cloneMethod(globalAdapter, my, 'createVideo'); // FrameRate
  ...
  utils.cloneMethod(globalAdapter, my, 'onMessage'); // Subpackage

  utils.cloneMethod(globalAdapter, my, 'loadSubpackage'); // SharedCanvas

  utils.cloneMethod(globalAdapter, my, 'getSharedCanvas'); // Font

  utils.cloneMethod(globalAdapter, my, 'loadFont'); // hide show Event

  utils.cloneMethod(globalAdapter, my, 'onShow');
  utils.cloneMethod(globalAdapter, my, 'onHide'); // onError

  utils.cloneMethod(globalAdapter, my, 'onError'); // offError

  utils.cloneMethod(globalAdapter, my, 'offError'); // Font
