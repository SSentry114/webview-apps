System.register("q-bundled:///fs/cocos/animation/tracks/track.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../core/index.js", "../../scene-graph/index.js", "../define.js", "../target-path.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TrackBinding", TrackBinding = (_dec2 = ccclass(`${CLASS_NAME_PREFIX_ANIM}TrackBinding`), _dec2(_class4 = uniquelyReferenced(_class4 = (_class5 = (_temp = _class6 = class TrackBinding {
        constructor() {
