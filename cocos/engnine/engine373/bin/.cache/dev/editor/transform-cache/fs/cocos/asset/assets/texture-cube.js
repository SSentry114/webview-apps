System.register("q-bundled:///fs/cocos/asset/assets/texture-cube.js", ["../../../../virtual/internal%253Aconstants.js", "../../core/data/decorators/index.js", "../../gfx/index.js", "./image-asset.js", "./simple-texture.js", "./texture-2d.js", "../../core/global-exports.js", "../../core/index.js", "../../../pal/system-info/enum-type/index.js"], function (_export, _context) {
  ...
  var EDITOR, OPPO, TEST, VIVO, WECHAT, WECHAT_MINI_PROGRAM, ccclass, serializable, TextureType, TextureInfo, TextureViewInfo, BufferTextureCopy, ImageAsset, SimpleTexture, Texture2D, legacyCC, ccwindow, js, sys, OS, _dec, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _class3, _temp, FaceIndex, MipmapMode, TextureCube;
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("TextureCube", TextureCube = (_dec = ccclass('cc.TextureCube'), _dec(_class = (_class2 = (_temp = _class3 = class TextureCube extends SimpleTexture {
        constructor(...args) {
          super(...args);
      ...
      }, _class3.FaceIndex = FaceIndex, _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "isRGBE", [serializable], function () {
        return false;
