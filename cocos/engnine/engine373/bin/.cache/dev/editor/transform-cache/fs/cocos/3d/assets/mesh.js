System.register("q-bundled:///fs/cocos/3d/assets/mesh.js", ["../../core/data/decorators/index.js", "../../asset/assets/asset.js", "../misc/buffer-blob.js", "../../core/index.js", "../../asset/assets/index.js", "../../gfx/index.js", "./morph-rendering.js"], function (_export, _context) {
  "use strict";

  var ccclass, serializable, Asset, BufferBlob, geometry, cclegacy, sys, warnID, Quat, Vec3, assertIsTrue, murmurhash2_32_gc, RenderingSubMesh, Attribute, BufferInfo, AttributeName, BufferUsageBit, Feature, Format, FormatInfos, FormatType, MemoryUsageBit, getTypedArrayConstructor, DrawInfo, deviceManager, createMorphRendering, _dec, _class, _class2, _initializer, _initializer2, _initializer3, v3_1, v3_2, globalEmptyMeshBuffer, Mesh, isLittleEndian;
    ...
    execute: function () {
      ...
      _export("Mesh", Mesh = (_dec = ccclass('cc.Mesh'), _dec(_class = (_class2 = class Mesh extends Asset {
        ...
        updateSubMesh(primitiveIndex, dynamicGeometry) {
          ...
          const drawInfo = subMesh.drawInfo; // update _data & buffer
        ...
        merge(mesh, worldMatrix, validate) {
          ...
          const bufferBlob = new BufferBlob(); // merge vertex buffer
