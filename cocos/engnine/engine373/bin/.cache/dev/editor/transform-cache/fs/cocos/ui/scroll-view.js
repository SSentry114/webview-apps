System.register("q-bundled:///fs/cocos/ui/scroll-view.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "../scene-graph/component-event-handler.js", "../2d/framework/index.js", "../input/types/index.js", "../core/platform/debug.js", "../core/math/index.js", "./layout.js", "./scroll-bar.js", "./view-group.js", "../scene-graph/node.js", "../game/director.js", "../scene-graph/node-enum.js", "../core/global-exports.js", "../scene-graph/node-event.js", "../input/input.js", "../xr/event/xr-event-handle.js"], function (_export, _context) {
  "use strict";

  var ccclass, help, executionOrder, menu, requireComponent, tooltip, displayOrder, range, type, serializable, EDITOR, ComponentEventHandler, UITransform, Event, EventTouch, SystemEventType, EventHandle, EventGamepad, errorID, logID, Vec2, Vec3, Layout, ScrollBar, ViewGroup, Node, director, Director, TransformBit, legacyCC, NodeEventType, Input, input, DeviceType, XrUIPressEventType, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _dec28, _dec29, _dec30, _dec31, _dec32, _dec33, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _initializer5, _initializer6, _initializer7, _initializer8, _initializer9, _initializer10, _initializer11, _class3, _temp, NUMBER_OF_GATHERED_TOUCHES_FOR_MOVE_SPEED, OUT_OF_BOUNDARY_BREAKING_FACTOR, EPSILON, TOLERANCE, MOVEMENT_FACTOR, _tempVec3, _tempVec3_1, _tempVec2, _tempVec2_1, quintEaseOut, getTimeInMilliseconds, eventMap, EventType, XrhoverType, ScrollView;
    ...
    execute: function () {
      ...
      _export("ScrollView", ScrollView = (_dec = ccclass('cc.ScrollView'), _dec2 = help('i18n:cc.ScrollView'), _dec3 = executionOrder(110), _dec4 = menu('UI/ScrollView'), _dec5 = requireComponent(UITransform), _dec6 = range([0, 10]), _dec7 = displayOrder(5), _dec8 = tooltip('i18n:scrollview.bounceDuration'), _dec9 = range([0, 1, 0.1]), _dec10 = displayOrder(3), _dec11 = tooltip('i18n:scrollview.brake'), _dec12 = displayOrder(3), _dec13 = tooltip('i18n:scrollview.elastic'), _dec14 = displayOrder(2), _dec15 = tooltip('i18n:scrollview.inertia'), _dec16 = type(Node), _dec17 = displayOrder(5), _dec18 = tooltip('i18n:scrollview.content'), _dec19 = displayOrder(0), _dec20 = tooltip('i18n:scrollview.horizontal'), _dec21 = type(ScrollBar), _dec22 = displayOrder(0), _dec23 = tooltip('i18n:scrollview.horizontal_bar'), _dec24 = displayOrder(1), _dec25 = tooltip('i18n:scrollview.vertical'), _dec26 = type(ScrollBar), _dec27 = displayOrder(1), _dec28 = tooltip('i18n:scrollview.vertical_bar'), _dec29 = displayOrder(9), _dec30 = tooltip('i18n:scrollview.cancelInnerEvents'), _dec31 = type([ComponentEventHandler]), _dec32 = displayOrder(10), _dec33 = tooltip('i18n:scrollview.scrollEvents'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = _class3 = class ScrollView extends ViewGroup {
        ...
        scrollToOffset(offset, timeInSecond, attenuated = true) {
          ...
          const anchor = new Vec2(0, 0); // if maxScrollOffset is 0, then always align the content's top left origin to the top left corner of its parent
      ...
      }, _class3.EventType = EventType, _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "bounceDuration", [serializable, _dec6, _dec7, _dec8], function () {
        return 1;
