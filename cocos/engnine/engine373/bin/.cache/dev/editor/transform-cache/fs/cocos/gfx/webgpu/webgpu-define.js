    ...
    execute: function () {
      WEBGPU && promiseForWebGPUInstantiation.then(() => {
        ...
        function seperateCombinedSamplerTexture(shaderSource) {
          ...
          const count = samplerTexturArr !== null && samplerTexturArr !== void 0 && samplerTexturArr.length ? samplerTexturArr === null || samplerTexturArr === void 0 ? void 0 : samplerTexturArr.length : 0;
          let code = shaderSource;
          const referredFuncMap = new Map();
          const samplerSet = new Set();
          samplerTexturArr === null || samplerTexturArr === void 0 ? void 0 : samplerTexturArr.every(str => {
            ...
            let samplerStr = str.replace(textureName, `${textureName}Sampler`); // let samplerFunc = samplerStr.match(/(?<=uniform(.*?))sampler(\w*)/g)!.toString();
          ...
          let functionDefs = '';
          const precisionKeyWord = 'highp'; // const getPrecision = (idx: number) => {
