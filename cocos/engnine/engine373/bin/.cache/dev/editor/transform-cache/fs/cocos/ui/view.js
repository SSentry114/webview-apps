System.register("q-bundled:///fs/cocos/ui/view.js", ["../core/data/class.js", "../../../virtual/internal%253Aconstants.js", "pal/screen-adapter", "../core/event/index.js", "../core/math/index.js", "../core/index.js", "../../pal/screen-adapter/enum-type/index.js", "../game/director.js", "../core/settings.js"], function (_export, _context) {
  ...
  var MINIGAME, JSB, RUNTIME_BASED, EDITOR, screenAdapter, Eventify, Rect, Size, Vec2, visibleRect, cclegacy, errorID, screen, macro, System, Orientation, director, Settings, settings, View, ContainerStrategy, ContentStrategy, ResolutionPolicy, localWinSize, orientationMap, view;
    ...
    execute: function () {
      ...
      _export("View", View = class View extends Eventify(System) {
        ...
        constructor() {
          ...
          this._viewportRect = new Rect(0, 0, 0, 0); // The visible rect in content's coordinate in point

          this._visibleRect = new Rect(0, 0, 0, 0); // Auto full screen disabled by default
        ...
        _updateAdaptResult(width, height, windowId) {
          ...
          cclegacy.director.root.resize(width, height, windowId === undefined ? 1 : windowId); // Frame size changed, do resize works
