System.register("q-bundled:///fs/cocos/2d/assets/sprite-frame.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../core/index.js", "../../asset/assets/asset.js", "../../asset/assets/image-asset.js", "../../asset/assets/texture-2d.js", "../utils/dynamic-atlas/atlas-manager.js", "../../3d/misc/index.js", "../../gfx/index.js", "../../core/global-exports.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("SpriteFrame", SpriteFrame = (_dec = ccclass('cc.SpriteFrame'), _dec(_class = (_temp = _class2 = class SpriteFrame extends Asset {
        /**
        ...
        _calcTrimmedBorder() {
          ...
          const halfTrimmedHeight = (oh - rh) * 0.5; // left

          this._trimmedBorder.x = this._offset.x + halfTrimmedWidth; // right

          this._trimmedBorder.y = this._offset.x - halfTrimmedWidth; // bottom

          this._trimmedBorder.z = this._offset.y + halfTrimmedHeight; // top
        ...
        ensureMeshData() {
          if (this._mesh) return; // If SpriteFrame from load, we need init vertices when use mesh
        ...
        _initVertices() {
          ...
          if (this._meshType === MeshType.POLYGON) {// Use Bayazit to generate vertices and assign values
          } else {
            // Rect mode
            ...
            const b = texh === 0 ? 0 : rect.y / texh; // left bottom
            ...
            this.vertices.minPos.set(temp_vec3); // right bottom
            ...
            this.vertices.nuv.push(b); // left top
            ...
            this.vertices.nuv.push(l);
            this.vertices.nuv.push(t); // right top
      ...
      }, _class2.EVENT_UV_UPDATED = 'uv_updated', _class2.MeshType = MeshType, _temp)) || _class));
