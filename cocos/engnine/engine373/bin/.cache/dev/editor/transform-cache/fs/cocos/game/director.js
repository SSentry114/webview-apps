System.register("q-bundled:///fs/cocos/game/director.js", ["../../../virtual/internal%253Aconstants.js", "../asset/assets/scene-asset.js", "../core/index.js", "../input/index.js", "../root.js", "../scene-graph/index.js", "../scene-graph/component-scheduler.js", "../scene-graph/node-activator.js", "../core/memop/scalable-container.js", "../2d/framework/ui-renderer-manager.js", "../asset/asset-manager/index.js", "../gfx/index.js"], function (_export, _context) {
  "use strict";

  var DEBUG, EDITOR, BUILD, TEST, SceneAsset, System, EventTarget, Scheduler, js, errorID, error, assertID, warnID, macro, CCObject, cclegacy, isValid, input, Root, Node, Scene, ComponentScheduler, NodeActivator, scalableContainerManager, uiRendererManager, assetManager, deviceManager, Director, director;
    ...
    execute: function () {
      ...
      _export("Director", Director = class Director extends EventTarget {
        ...
        constructor() {
          ...
          this._scheduler = new Scheduler(); // Scheduler for life-cycle methods in component

          this._compScheduler = new ComponentScheduler(); // Node activator
        ...
        runSceneImmediate(scene, onBeforeLoadScene, onLaunched) {
          ...
          for (let i = 0; i < persistNodeList.length; i++) {
            ...
            if (existNode) {
              ...
              const index = existNode.getSiblingIndex(); // restore to the old saving flag
          ...
          this.emit(Director.EVENT_BEFORE_SCENE_LAUNCH, scene); // Run an Entity Scene
        ...
        runScene(scene, onBeforeLoadScene, onLaunched) {
          if (scene instanceof SceneAsset) scene = scene.scene;
          assertID(scene, 1205);
          assertID(scene instanceof Scene, 1216); // Delay run / replace scene to the end of the frame
        ...
        addPersistRootNode(node) {
          ...
          if (!this._persistRootNodes[id]) {
            ...
            node._persistNode = true; // @ts-expect-error Using private API
        ...
        removePersistRootNode(node) {
          ...
          if (node === this._persistRootNodes[id]) {
            ...
            node._originalSceneId = ''; // @ts-expect-error Using private API
