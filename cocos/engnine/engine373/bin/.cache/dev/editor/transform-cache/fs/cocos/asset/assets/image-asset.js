System.register("q-bundled:///fs/cocos/asset/assets/image-asset.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../gfx/index.js", "./asset.js", "./asset-enum.js", "../../core/index.js", "../../core/global-exports.js", "../../core/value-types/enum.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ImageAsset", ImageAsset = (_dec = ccclass('cc.ImageAsset'), _dec(_class = (_class2 = (_temp = _class3 = class ImageAsset extends Asset {
        /**
        ...
        static mergeCompressedTextureMips(files) {
          ...
          try {
            ...
            const outView = new DataView(out.buffer, out.byteOffset, out.byteLength); // Append compresssed header
        ...
        static parseCompressedTextures(file, type) {
          ...
          const bufferView = new DataView(buffer); // Get a view of the arrayBuffer that represents compress header.

          const magicNumber = bufferView.getUint32(0, true); // Do some sanity checks to make sure this is a valid compress file.
          ...
          if (magicNumber === COMPRESSED_MIPMAP_MAGIC) {
            ...
            const fileHeaderByteLength = COMPRESSED_HEADER_LENGTH + COMPRESSED_MIPMAP_LEVEL_COUNT_LENGTH + mipmapLevelNumber * COMPRESSED_MIPMAP_DATA_SIZE_LENGTH; // Get a view of the arrayBuffer that represents compress chunks.
        ...
        static parsePVRTexture(file, levelIndex, beginOffset, endOffset, out) {
          ...
          const header = new Int32Array(buffer, beginOffset, PVR_HEADER_LENGTH); // Do some sanity checks to make sure this is a valid DDS file.
      ...
      }, _class3.extnames = ['.png', '.jpg', '.jpeg', '.bmp', '.webp', '.pvr', '.pkm', '.astc'], _class3._sharedPlaceHolderCanvas = null, _temp), (_applyDecoratedDescriptor(_class2.prototype, "_nativeAsset", [override], Object.getOwnPropertyDescriptor(_class2.prototype, "_nativeAsset"), _class2.prototype)), _class2)) || _class));
