System.register("q-bundled:///fs/cocos/3d/framework/mesh-renderer.js", ["../../../../virtual/internal%253Aconstants.js", "../../core/data/decorators/index.js", "../assets/mesh.js", "../../core/index.js", "../../render-scene/index.js", "../models/morph-model.js", "../../scene-graph/node-enum.js", "../../misc/model-renderer.js", "../../scene-graph/node-event.js", "../../asset/asset-manager/builtin-res-mgr.js", "../../core/settings.js"], function (_export, _context) {
  "use strict";

  var JSB, displayOrder, group, range, Mesh, Vec4, Enum, cclegacy, CCBoolean, CCFloat, assertIsTrue, _decorator, CCInteger, EventTarget, warnID, scene, MorphModel, MobilityMode, TransformBit, ModelRenderer, NodeEventType, builtinResMgr, settings, Settings, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _initializer5, _initializer6, _initializer7, _initializer8, _initializer9, _initializer10, _initializer11, _class3, _temp, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _dec28, _dec29, _dec30, _dec31, _dec32, _dec33, _dec34, _dec35, _dec36, _dec37, _class4, _class5, _initializer12, _initializer13, _initializer14, _initializer15, _initializer16, _initializer17, _initializer18, _initializer19, _class6, _temp2, property, ccclass, help, executeInEditMode, executionOrder, menu, tooltip, visible, type, formerlySerializedAs, serializable, editable, disallowAnimation, ModelShadowCastingMode, ModelShadowReceivingMode, ReflectionProbeType, ModelBakeSettings, MeshRenderer;
  ...
  return {
    ...
    execute: function () {
      ...
      ModelBakeSettings = (_dec = ccclass('cc.ModelBakeSettings'), _dec2 = formerlySerializedAs('_recieveShadow'), _dec3 = group({
        ...
        id: 'ReflectionProbe',
        name: 'ReflectionProbeSettings',
        displayOrder: 2
      }), _dec14 = type(Enum(ReflectionProbeType)), _dec15 = group({
        id: 'ReflectionProbe',
        name: 'ReflectionProbeSettings'
      }), _dec16 = type(CCBoolean), _dec(_class = (_class2 = (_temp = _class3 = class ModelBakeSettings extends EventTarget {
        constructor(...args) {
          super(...args);
          ...
          this._probeCubemap = _initializer11 && _initializer11();
          this._probePlanarmap = null;
        }
      ...
      }, _class3.USE_LIGHT_PROBE_CHANGED = 'use_light_probe_changed', _class3.REFLECTION_PROBE_CHANGED = 'reflection_probe_changed', _class3.BAKE_TO_REFLECTION_PROBE_CHANGED = 'bake_to_reflection_probe_changed', _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "texture", [serializable], function () {
        return null;
        ...
        return true;
      }), _initializer11 = _applyDecoratedInitializer(_class2.prototype, "_probeCubemap", [serializable], function () {
        return null;
      ...
      _export("MeshRenderer", MeshRenderer = (_dec17 = ccclass('cc.MeshRenderer'), _dec18 = help('i18n:cc.MeshRenderer'), _dec19 = executionOrder(100), _dec20 = menu('Mesh/MeshRenderer'), _dec21 = displayOrder(3), _dec22 = type(CCFloat), _dec23 = tooltip('i18n:model.shadow_bias'), _dec24 = group({
        id: 'DynamicShadow',
        name: 'DynamicShadowSettings',
        displayOrder: 2
      }), _dec25 = type(CCFloat), _dec26 = tooltip('i18n:model.shadow_normal_bias'), _dec27 = group({
        id: 'DynamicShadow',
        name: 'DynamicShadowSettings'
      }), _dec28 = type(ModelShadowCastingMode), _dec29 = tooltip('i18n:model.shadow_casting_model'), _dec30 = group({
        id: 'DynamicShadow',
        name: 'DynamicShadowSettings'
      }), _dec31 = type(ModelShadowReceivingMode), _dec32 = tooltip('i18n:model.shadow_receiving_model'), _dec33 = group({
        id: 'DynamicShadow',
        name: 'DynamicShadowSettings'
      }), _dec34 = type(Mesh), _dec35 = displayOrder(1), _dec36 = tooltip('i18n:model.mesh'), _dec37 = visible(function () {
        return !!(this.mesh && this.mesh.struct.morph && this.mesh.struct.morph.subMeshMorphs.some(subMeshMorph => !!subMeshMorph));
      }), _dec17(_class4 = _dec18(_class4 = _dec19(_class4 = _dec20(_class4 = executeInEditMode(_class4 = (_class5 = (_temp2 = _class6 = class MeshRenderer extends ModelRenderer {
        /**
        ...
        */
        ...
        constructor() {
          super();
          this.bakeSettings = _initializer12 && _initializer12();
          this._mesh = _initializer13 && _initializer13();
          this._shadowCastingMode = _initializer14 && _initializer14();
          this._shadowReceivingMode = _initializer15 && _initializer15();
          this._shadowBias = _initializer16 && _initializer16();
          this._shadowNormalBias = _initializer17 && _initializer17();
          this._reflectionProbeId = _initializer18 && _initializer18();
          this._reflectionProbeDataMap = null;
          this._subMeshShapesWeights = [];
          this._modelType = void 0;
          this._model = null;
          this._morphInstance = null;
          this._enableMorph = _initializer19 && _initializer19();
        ...
        updateProbeCubemap(cubeMap, useDefaultTexture) {
        ...
        _updateReceiveDirLight() {
          ...
          if (mainLight.node.mobility === MobilityMode.Static && (this.bakeSettings.texture || this.node.scene.globals.lightProbeInfo.data && this.node.scene.globals.lightProbeInfo.data.hasCoefficients() && this._model.useLightProbe)) {
        ...
        _onUpdateLocalShadowBiasAndProbeId() {
          ...
          this.setInstancedAttribute('a_localShadowBiasAndProbeId', [this._shadowBias, this._shadowNormalBias, this._reflectionProbeId, 0.0]);
        }
      ...
      }, _class6.ShadowCastingMode = ModelShadowCastingMode, _class6.ShadowReceivingMode = ModelShadowReceivingMode, _temp2), (_initializer12 = _applyDecoratedInitializer(_class5.prototype, "bakeSettings", [serializable, editable, disallowAnimation, _dec21], function () {
        return new ModelBakeSettings(this);
      }), _initializer13 = _applyDecoratedInitializer(_class5.prototype, "_mesh", [serializable], function () {
        return null;
      }), _initializer14 = _applyDecoratedInitializer(_class5.prototype, "_shadowCastingMode", [serializable], function () {
        return ModelShadowCastingMode.OFF;
      }), _initializer15 = _applyDecoratedInitializer(_class5.prototype, "_shadowReceivingMode", [serializable], function () {
        return ModelShadowReceivingMode.ON;
      }), _initializer16 = _applyDecoratedInitializer(_class5.prototype, "_shadowBias", [serializable], function () {
        return 0;
      }), _initializer17 = _applyDecoratedInitializer(_class5.prototype, "_shadowNormalBias", [serializable], function () {
        return 0;
      }), _initializer18 = _applyDecoratedInitializer(_class5.prototype, "_reflectionProbeId", [serializable], function () {
        return -1;
      }), _applyDecoratedDescriptor(_class5.prototype, "shadowBias", [_dec22, _dec23, _dec24, disallowAnimation], Object.getOwnPropertyDescriptor(_class5.prototype, "shadowBias"), _class5.prototype), _applyDecoratedDescriptor(_class5.prototype, "shadowNormalBias", [_dec25, _dec26, _dec27, disallowAnimation], Object.getOwnPropertyDescriptor(_class5.prototype, "shadowNormalBias"), _class5.prototype), _applyDecoratedDescriptor(_class5.prototype, "shadowCastingMode", [_dec28, _dec29, _dec30, disallowAnimation], Object.getOwnPropertyDescriptor(_class5.prototype, "shadowCastingMode"), _class5.prototype), _applyDecoratedDescriptor(_class5.prototype, "receiveShadow", [_dec31, _dec32, _dec33, disallowAnimation], Object.getOwnPropertyDescriptor(_class5.prototype, "receiveShadow"), _class5.prototype), _applyDecoratedDescriptor(_class5.prototype, "mesh", [_dec34, _dec35, _dec36], Object.getOwnPropertyDescriptor(_class5.prototype, "mesh"), _class5.prototype), _applyDecoratedDescriptor(_class5.prototype, "enableMorph", [_dec37, disallowAnimation], Object.getOwnPropertyDescriptor(_class5.prototype, "enableMorph"), _class5.prototype), _initializer19 = _applyDecoratedInitializer(_class5.prototype, "_enableMorph", [serializable], function () {
        return true;
