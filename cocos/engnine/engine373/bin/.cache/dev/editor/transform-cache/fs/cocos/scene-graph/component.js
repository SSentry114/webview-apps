System.register("q-bundled:///fs/cocos/scene-graph/component.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "../asset/assets/scripts.js", "../core/data/object.js", "../core/utils/id-generator.js", "../core/utils/js.js", "../core/data/utils/requiring-frame.js", "../core/global-exports.js", "../core/platform/debug.js", "./component-event-handler.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Component", Component = (_dec = ccclass('cc.Component'), _dec2 = displayName('Script'), _dec3 = type(Script), _dec4 = tooltip('i18n:INSPECTOR.component.script'), _dec(_class = (_class2 = (_temp = _class3 = class Component extends CCObject {
        constructor(...args) {
          super(...args);
        ...
        _onPreDestroy() {
          // Schedules
          this.unscheduleAllCallbacks(); // onDestroy
        ...
        schedule(callback, interval = 0, repeat = legacyCC.macro.REPEAT_FOREVER, delay = 0) {
          ...
          delay = delay || 0;
          const scheduler = legacyCC.director.getScheduler(); // should not use enabledInHierarchy to judge whether paused,
