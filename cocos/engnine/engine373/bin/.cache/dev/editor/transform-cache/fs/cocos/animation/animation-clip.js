System.register("q-bundled:///fs/cocos/animation/animation-clip.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "../asset/assets/asset.js", "../core/index.js", "../3d/skeletal-animation/skeletal-animation-data-hub.js", "./types.js", "../scene-graph/node.js", "./legacy-clip-data.js", "./internal-symbols.js", "./tracks/track.js", "./define.js", "./tracks/untyped-track.js", "./tracks/object-track.js", "./exotic-animation/exotic-animation.js", "./global-animation-manager.js"], function (_export, _context) {
  ...
  var ccclass, serializable, DEBUG, Asset, errorID, warnID, cclegacy, js, geometry, approx, clamp, Mat4, Quat, Vec3, murmurhash2_32_gc, binarySearchEpsilon, assertIsTrue, SkelAnimDataHub, AnimationWrapMode, WrapMode, Node, legacy, BAKE_SKELETON_CURVE_SYMBOL, trackBindingTag, TrackPath, createEvalSymbol, UntypedTrack, ObjectTrack, getGlobalAnimationManager, EmbeddedPlayerEvaluation, AnimationClipEvaluation, BoneTransform, BoneGlobalTransform, RootMotionEvaluation, EventEvaluator, _dec, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _initializer5, _initializer6, _initializer7, _initializer8, _initializer9, _initializer10, _class3, _temp, searchForRootBonePathSymbol, exoticAnimationTag, embeddedPlayerCountTag, getEmbeddedPlayersTag, addEmbeddedPlayerTag, removeEmbeddedPlayerTag, clearEmbeddedPlayersTag, AnimationClip, motionTransformCache, InvalidIndex;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("AnimationClip", AnimationClip = (_dec = ccclass('cc.AnimationClip'), _dec(_class = (_class2 = (_temp = _class3 = class AnimationClip extends Asset {
        constructor(...args) {
          super(...args);
      ...
      }, _class3.WrapMode = AnimationWrapMode, _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "sample", [serializable], function () {
        return 60;
        ...
        notifyHostPlay(time) {
          ...
          for (let iEmbeddedPlayer = 0; iEmbeddedPlayer < nEmbeddedPlayers; ++iEmbeddedPlayer) {
            ...
            if (entered) {
              const {
                hostPauseTime
              } = embeddedPlayerEvaluationInfo; // We can resume the embedded player
