System.register("q-bundled:///fs/cocos/particle-2d/particle-simulator-2d.js", ["../core/index.js", "../2d/renderer/vertex-format.js", "./define.js"], function (_export, _context) {
  ...
  var Vec2, Color, js, misc, vfmtPosUvColor, getComponentPerVertex, PositionType, EmitterMode, START_SIZE_EQUAL_TO_END_SIZE, START_RADIUS_EQUAL_TO_END_RADIUS, Particle, ParticlePool, Simulator, ZERO_VEC2, _pos, _tpa, _tpb, _tpc, formatBytes, pool;
    ...
    execute: function () {
      ...
      _export("Simulator", Simulator = class Simulator {
        ...
        emitParticle(pos) {
          ...
          const a = misc.degreesToRadians(psys.angle + this._worldRotation + psys.angleVar * (Math.random() - 0.5) * 2); // Mode Gravity: A
