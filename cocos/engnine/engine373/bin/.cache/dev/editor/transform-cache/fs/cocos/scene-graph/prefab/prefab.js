System.register("q-bundled:///fs/cocos/scene-graph/prefab/prefab.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../serialization/instantiate-jit.js", "../../core/index.js", "../../core/value-types/index.js", "../../asset/assets/asset.js", "../node.js", "../../core/global-exports.js", "../../core/platform/debug.js", "../../core/utils/jsb-utils.js", "./utils.js"], function (_export, _context) {
  ...
  var ccclass, serializable, editable, SUPPORT_JIT, ALIPAY, RUNTIME_BASED, JSB, compile, js, Enum, Asset, Node, legacyCC, warnID, updateChildrenForDeserialize, utils, _dec, _class, _class2, _initializer, _initializer2, _initializer3, _class3, _temp, OptimizationPolicy, Prefab;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Prefab", Prefab = (_dec = ccclass('cc.Prefab'), _dec(_class = (_class2 = (_temp = _class3 = class Prefab extends Asset {
        /**
      ...
      }, _class3.OptimizationPolicy = OptimizationPolicy, _class3.OptimizationPolicyThreshold = 3, _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "data", [serializable, editable], function () {
        return null;
