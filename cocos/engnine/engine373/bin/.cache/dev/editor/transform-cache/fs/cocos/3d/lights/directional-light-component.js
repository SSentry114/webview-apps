System.register("q-bundled:///fs/cocos/3d/lights/directional-light-component.js", ["./light-component.js", "../../render-scene/index.js", "../../core/index.js", "../../render-scene/scene/index.js", "../framework/index.js", "../../game/director.js"], function (_export, _context) {
  "use strict";

  var Light, scene, cclegacy, clamp, warnID, CCBoolean, CCFloat, _decorator, settings, Settings, Camera, PCFType, Shadows, ShadowType, CSMOptimizationMode, CSMLevel, MeshRenderer, director, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _dec28, _dec29, _dec30, _dec31, _dec32, _dec33, _dec34, _dec35, _dec36, _dec37, _dec38, _dec39, _dec40, _dec41, _dec42, _dec43, _dec44, _dec45, _dec46, _dec47, _dec48, _dec49, _dec50, _dec51, _dec52, _dec53, _dec54, _dec55, _dec56, _dec57, _dec58, _dec59, _dec60, _dec61, _dec62, _dec63, _dec64, _dec65, _dec66, _dec67, _dec68, _dec69, _dec70, _dec71, _dec72, _dec73, _dec74, _dec75, _dec76, _dec77, _dec78, _dec79, _dec80, _dec81, _dec82, _dec83, _dec84, _dec85, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _initializer5, _initializer6, _initializer7, _initializer8, _initializer9, _initializer10, _initializer11, _initializer12, _initializer13, _initializer14, _initializer15, _initializer16, _initializer17, _initializer18, _initializer19, ccclass, menu, executeInEditMode, property, serializable, formerlySerializedAs, tooltip, help, visible, type, editable, slide, range, DirectionalLight;
  ...
  return {
    setters: [function (_lightComponentJs) {
      ...
      MeshRenderer = _frameworkIndexJs.MeshRenderer;
    ...
    execute: function () {
      ...
      _export("DirectionalLight", DirectionalLight = (_dec = ccclass('cc.DirectionalLight'), _dec2 = help('i18n:cc.DirectionalLight'), _dec3 = menu('Light/DirectionalLight'), _dec4 = formerlySerializedAs('_illuminance'), _dec5 = tooltip('i18n:lights.illuminance'), _dec6 = tooltip('i18n:lights.shadowEnabled'), _dec7 = visible(() => cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap), _dec8 = property({
        group: {
          name: 'DynamicShadowSettings',
          displayOrder: 1
        }
      }), _dec9 = type(CCBoolean), _dec10 = tooltip('i18n:lights.shadowPcf'), _dec11 = visible(() => cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap), _dec12 = property({
        group: {
          name: 'DynamicShadowSettings',
          displayOrder: 5
        }
      }), _dec13 = type(PCFType), _dec14 = tooltip('i18n:lights.shadowBias'), _dec15 = visible(() => cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap), _dec16 = property({
        group: {
          name: 'DynamicShadowSettings',
          displayOrder: 6
        }
      }), _dec17 = type(CCFloat), _dec18 = tooltip('i18n:lights.shadowNormalBias'), _dec19 = visible(() => cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap), _dec20 = property({
        group: {
          name: 'DynamicShadowSettings',
          displayOrder: 7
        }
      }), _dec21 = type(CCFloat), _dec22 = tooltip('i18n:lights.shadowSaturation'), _dec23 = visible(() => cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap), _dec24 = property({
        group: {
          name: 'DynamicShadowSettings',
          displayOrder: 8
        }
      ...
      }), _dec55 = tooltip('CSM Performance Optimization Mode'), _dec56 = type(CSMOptimizationMode), _dec57 = tooltip('i18n:lights.shadowFixedArea'), _dec58 = visible(() => cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap), _dec59 = property({
        group: {
          name: 'DynamicShadowSettings',
          displayOrder: 14
        }
      ...
      }), _dec84 = range([0.0, 0.1, 0.01]), _dec85 = type(CCFloat), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = class DirectionalLight extends Light {
        ...
        */
        ...
        _createLight() {
          ...
          if (this._light) {
            ...
            dirLight.illuminanceLDR = this._illuminanceLDR; // shadow info
