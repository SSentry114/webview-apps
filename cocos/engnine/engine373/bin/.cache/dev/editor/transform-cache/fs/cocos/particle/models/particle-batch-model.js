System.register("q-bundled:///fs/cocos/particle/models/particle-batch-model.js", ["../../../../virtual/internal%253Aconstants.js", "../../gfx/index.js", "../../core/index.js", "../../render-scene/index.js", "../../asset/assets/index.js"], function (_export, _context) {
  ...
  var JSB, AttributeName, BufferUsageBit, FormatInfos, MemoryUsageBit, PrimitiveMode, DRAW_INFO_SIZE, IndirectBuffer, BufferInfo, DrawInfo, Feature, deviceManager, Color, scene, RenderingSubMesh, ParticleBatchModel, _uvs, _uvs_ins;
    ...
    execute: function () {
      ...
      _export("default", ParticleBatchModel = class ParticleBatchModel extends scene.Model {
        ...
        createSubMeshData() {
          ...
          const vertexBuffer = this._device.createBuffer(new BufferInfo(BufferUsageBit.VERTEX | BufferUsageBit.TRANSFER_DST, MemoryUsageBit.HOST | MemoryUsageBit.DEVICE, this._vertAttribSize * this._capacity * this._vertCount, this._vertAttribSize));

          const vBuffer = new ArrayBuffer(this._vertAttribSize * this._capacity * this._vertCount);
        ...
        createSubMeshDataInsDynamic() {
          ...
          const vertexBuffer = this._device.createBuffer(new BufferInfo(BufferUsageBit.VERTEX | BufferUsageBit.TRANSFER_DST, MemoryUsageBit.HOST | MemoryUsageBit.DEVICE, this._vertAttribSize * this._capacity, this._vertAttribSize));

          const vBuffer = new ArrayBuffer(this._vertAttribSize * this._capacity);
          vertexBuffer.update(vBuffer);
