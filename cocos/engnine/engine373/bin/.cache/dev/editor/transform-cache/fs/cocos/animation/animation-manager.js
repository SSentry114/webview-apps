System.register("q-bundled:///fs/cocos/animation/animation-manager.js", ["../core/data/decorators/index.js", "../core/index.js", "../game/director.js", "../3d/skeletal-animation/skeletal-animation-blending.js", "./skeletal-animation-utils.js"], function (_export, _context) {
  ...
  var ccclass, System, errorID, cclegacy, js, director, Director, LegacyBlendStateBuffer, deleteTransform, getTransform, getWorldMatrix, _class, _class2, _temp, AnimationManager;
  ...
  return {
    ...
    execute: function () {
      _export("AnimationManager", AnimationManager = ccclass(_class = (_temp = _class2 = class AnimationManager extends System {
        constructor(...args) {
          super(...args);
