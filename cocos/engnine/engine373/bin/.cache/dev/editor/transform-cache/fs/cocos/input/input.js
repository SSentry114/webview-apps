System.register("q-bundled:///fs/cocos/input/input.js", ["../../../virtual/internal%253Aconstants.js", "pal/input", "../../pal/input/touch-manager.js", "../core/index.js", "./types/index.js", "./types/event-enum.js"], function (_export, _context) {
  ...
  var EDITOR, NATIVE, TouchInputSource, MouseInputSource, KeyboardInputSource, AccelerometerInputSource, GamepadInputDevice, HandleInputDevice, HMDInputDevice, HandheldInputDevice, touchManager, sys, EventTarget, cclegacy, EventTouch, InputEventType, InputEventDispatcher, Input, EventDispatcherPriority, pointerEventTypeMap, input;
    ...
    execute: function () {
      ...
      _export("Input", Input = class Input {
        ...
        _frameDispatchEvents() {
          const eventHMDList = this._eventHMDList; // TODO: culling event queue
          ...
          const eventHandheldList = this._eventHandheldList; // TODO: culling event queue
          ...
          const eventGamepadList = this._eventGamepadList; // TODO: culling event queue
          ...
          const eventHandleList = this._eventHandleList; // TODO: culling event queue
