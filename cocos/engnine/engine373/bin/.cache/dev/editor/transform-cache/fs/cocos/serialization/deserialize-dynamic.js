...
`);
  ...
  function compileDeserializeJIT(self, klass) {
    ...
    const fastMode = misc.BUILTIN_CLASSID_RE.test(js.getClassId(klass)); // sources.push('var vb,vn,vs,vo,vu,vf;');    // boolean, number, string, object, undefined, function
  ...
  function deserializeDynamic(data, details, options) {
    ...
    const reportMissingClass = (_options$reportMissin = options.reportMissingClass) !== null && _options$reportMissin !== void 0 ? _options$reportMissin : cclegacy.deserialize.reportMissingClass; // var oldJson = JSON.stringify(data, null, 2);
    ...
    execute: function () {
      ...
      _Deserializer = class _Deserializer {
        ...
        _deserializeFastDefinedObject(instance, serialized, klass) {
          ...
          const attrs = CCClass.Attr.getClassAttrs(klass); // @ts-expect-error 2339
