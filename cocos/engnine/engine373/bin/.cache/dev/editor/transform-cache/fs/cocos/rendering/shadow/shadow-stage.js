System.register("q-bundled:///fs/cocos/rendering/shadow/shadow-stage.js", ["../../core/data/decorators/index.js", "../../gfx/index.js", "../render-stage.js", "../enum.js", "../render-shadow-map-batched-queue.js", "../define.js", "../../render-scene/scene/light.js", "../../render-scene/scene/index.js"], function (_export, _context) {
  "use strict";

  var ccclass, Color, Rect, RenderStage, ForwardStagePriority, RenderShadowMapBatchedQueue, SetIndex, LightType, CSMLevel, _dec, _class, _class2, _temp, colors, ShadowStage;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ShadowStage", ShadowStage = (_dec = ccclass('ShadowStage'), _dec(_class = (_temp = _class2 = class ShadowStage extends RenderStage {
        constructor(...args) {
          super(...args);
