  ...
  return {
    ...
    execute: function () {
      ...
      _export("Camera", Camera = (_dec = ccclass('cc.Camera'), _dec2 = help('i18n:cc.Camera'), _dec3 = menu('Rendering/Camera'), _dec4 = displayOrder(0), _dec5 = range([0, 65535, 1]), _dec6 = tooltip('i18n:camera.priority'), _dec7 = type(Layers.BitMask), _dec8 = displayOrder(1), _dec9 = tooltip('i18n:camera.visibility'), _dec10 = type(ClearFlag), _dec11 = displayOrder(2), _dec12 = tooltip('i18n:camera.clear_flags'), _dec13 = displayOrder(3), _dec14 = tooltip('i18n:camera.color'), _dec15 = displayOrder(4), _dec16 = tooltip('i18n:camera.depth'), _dec17 = displayOrder(5), _dec18 = tooltip('i18n:camera.stencil'), _dec19 = type(ProjectionType), _dec20 = displayOrder(6), _dec21 = tooltip('i18n:camera.projection'), _dec22 = type(FOVAxis), _dec23 = displayOrder(7), _dec24 = visible(function () {
        ...
        return this._projection === ProjectionType.PERSPECTIVE;
      }), _dec28 = range([1, 180, 1]), _dec29 = tooltip('i18n:camera.fov'), _dec30 = displayOrder(9), _dec31 = visible(function () {
        return this._projection === ProjectionType.ORTHO;
      }), _dec32 = rangeMin(1), _dec33 = tooltip('i18n:camera.ortho_height'), _dec34 = displayOrder(10), _dec35 = rangeMin(0), _dec36 = tooltip('i18n:camera.near'), _dec37 = displayOrder(11), _dec38 = rangeMin(0), _dec39 = tooltip('i18n:camera.far'), _dec40 = type(Aperture), _dec41 = displayOrder(12), _dec42 = tooltip('i18n:camera.aperture'), _dec43 = type(Shutter), _dec44 = displayOrder(13), _dec45 = tooltip('i18n:camera.shutter'), _dec46 = type(ISO), _dec47 = displayOrder(14), _dec48 = tooltip('i18n:camera.ISO'), _dec49 = displayOrder(15), _dec50 = tooltip('i18n:camera.rect'), _dec51 = type(RenderTexture), _dec52 = displayOrder(16), _dec53 = tooltip('i18n:camera.target_texture'), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = (_temp = _class3 = class Camera extends Component {
        constructor(...args) {
          super(...args);
          ...
          this._cameraType = _initializer19 && _initializer19();
          this._trackingType = _initializer20 && _initializer20();
        }
      ...
      }, _class3.ProjectionType = ProjectionType, _class3.FOVAxis = FOVAxis, _class3.ClearFlag = ClearFlag, _class3.Aperture = Aperture, _class3.Shutter = Shutter, _class3.ISO = ISO, _class3.TARGET_TEXTURE_CHANGE = 'tex-change', _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "_projection", [serializable], function () {
