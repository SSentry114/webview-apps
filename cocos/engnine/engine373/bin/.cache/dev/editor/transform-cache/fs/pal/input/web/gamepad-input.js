      ...
      _export("GamepadInputDevice", GamepadInputDevice = class GamepadInputDevice {
        ...
        static _scanWebGamepads(devices) {
          ...
          for (let i = 0; i < webGamepads.length; ++i) {
            const webGamepad = webGamepads === null || webGamepads === void 0 ? void 0 : webGamepads[i];

            if (!webGamepad) {
              continue;
            }

            const cachedWebGamepad = GamepadInputDevice._cachedWebGamepads[webGamepad.index]; // TODO: what if cachedWebGamepad is null
