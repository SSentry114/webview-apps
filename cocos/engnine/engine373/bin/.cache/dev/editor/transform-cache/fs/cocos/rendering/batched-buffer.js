System.register("q-bundled:///fs/cocos/rendering/batched-buffer.js", ["../gfx/index.js", "../core/index.js", "./define.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      _export("BatchedBuffer", BatchedBuffer = class BatchedBuffer {
        constructor(pass) {
          this.batches = [];
          this.dynamicOffsets = [];
          this._device = void 0;
