    ...
    execute: function () {
      ...
      _export("DeviceManager", DeviceManager = class DeviceManager {
        ...
        init(canvas, bindingMappingInfo) {
          ...
          this._canvas = canvas;
          this._renderType = this._determineRenderType(renderMode); // WebGL context created successfully
          ...
          if (this._renderType === RenderType.WEBGL) {
            ...
            if (JSB && globalThis.gfx) {
              ...
              const userAgent = globalThis.navigator.userAgent.toLowerCase(); // UC browser implementation doesn't conform to WebGL2 standard
