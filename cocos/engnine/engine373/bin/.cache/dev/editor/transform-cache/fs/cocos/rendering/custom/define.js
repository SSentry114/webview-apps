System.register("q-bundled:///fs/cocos/rendering/custom/define.js", ["../../../../virtual/internal%253Aconstants.js", "../../gfx/index.js", "../../render-scene/scene/index.js", "../define.js", "./types.js", "../../core/index.js", "../../asset/assets/index.js", "../pipeline-funcs.js"], function (_export, _context) {
  ...
  var EDITOR, BufferInfo, Buffer, BufferUsageBit, ClearFlagBit, Color, LoadOp, Format, Rect, Sampler, StoreOp, Texture, Viewport, MemoryUsageBit, Camera, CSMLevel, LightType, ShadowType, SKYBOX_FLAG, supportsR32FloatTexture, AccessType, AttachmentType, ComputeView, LightInfo, QueueHint, RasterView, ResourceResidency, SceneFlags, UpdateFrequency, Vec4, macro, geometry, toRadian, cclegacy, assert, Material, getProfilerCamera, SRGBToLinear, FxaaData, BloomData, PostInfo, CameraInfo, GBufferInfo, LightingInfo, AntiAliasing, _cameras, fxaaData, MAX_BLOOM_FILTER_PASS_NUM, BLOOM_PREFILTERPASS_INDEX, BLOOM_DOWNSAMPLEPASS_INDEX, BLOOM_UPSAMPLEPASS_INDEX, BLOOM_COMBINEPASS_INDEX, bloomData, postInfo, lightingInfo, layouts;
  ...
  function getRenderArea(camera, width, height, light = null, level = 0) {
    const out = new Rect();
  ...
  function buildFxaaPass(camera, ppl, inputRT) {
    ...
    const fxaaPassDSName = `dsFxaaPassDS${cameraName}`; // ppl.updateRenderWindow(inputRT, camera.window);
  ...
  function buildBloomPass(camera, ppl, inputRT, threshold = 0.1, iterations = 2, intensity = 0.8) {
    if (!bloomData) {
  ...
  function buildPostprocessPass(camera, ppl, inputTex, antiAliasing = AntiAliasing.NONE) {
  ...
  function buildNativeForwardPass(camera, ppl) {
    ...
    const area = getRenderArea(camera, camera.window.width, camera.window.height);
    const width = area.width;
    const height = area.height; // Resources
  ...
  function getDescBinding(descId, descData) {
    const layoutData = descData; // find descriptor binding
  ...
  return {
    ...
    execute: function () {
      ...
      LightingInfo = class LightingInfo {
        _init() {
