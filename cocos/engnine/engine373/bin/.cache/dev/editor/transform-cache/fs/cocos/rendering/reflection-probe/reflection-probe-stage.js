System.register("q-bundled:///fs/cocos/rendering/reflection-probe/reflection-probe-stage.js", ["../../core/data/decorators/index.js", "../../gfx/index.js", "../render-stage.js", "../enum.js", "../define.js", "../render-reflection-probe-queue.js", "../../core/index.js", "../../core/math/color.js"], function (_export, _context) {
  ...
  var ccclass, Color, Rect, ClearFlagBit, RenderStage, ForwardStagePriority, SetIndex, RenderReflectionProbeQueue, Vec3, packRGBE, _dec, _class, _class2, _temp, colors, ReflectionProbeStage;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ReflectionProbeStage", ReflectionProbeStage = (_dec = ccclass('ReflectionProbeStage'), _dec(_class = (_temp = _class2 = class ReflectionProbeStage extends RenderStage {
        constructor(...args) {
          super(...args);
