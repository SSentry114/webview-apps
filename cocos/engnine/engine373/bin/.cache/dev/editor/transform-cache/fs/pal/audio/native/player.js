System.register("q-bundled:///fs/pal/audio/native/player.js", ["pal/system-info", "../type.js", "../../../cocos/core/event/index.js", "../../../cocos/core/global-exports.js", "../../../cocos/core/index.js", "../operation-queue.js", "../../system-info/enum-type/index.js", "../../../cocos/game/index.js"], function (_export, _context) {
  ...
  var systemInfo, AudioType, AudioState, AudioEvent, AudioPCMDataView, EventTarget, legacyCC, clamp01, enqueueOperation, Platform, Game, game, OneShotAudio, _class, _class2, _temp, urlCount, audioEngine, INVALID_AUDIO_ID, AudioBufferFormat, bufferConstructorMap, AudioPlayer;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("AudioPlayer", AudioPlayer = (_class = (_temp = _class2 = class AudioPlayer {
        /**
        ...
        constructor(url) {
          ...
          this._url = url; // this._pcmHeader = audioEngine.getPCMHeader(url);

          this._pcmHeader = null; // event
