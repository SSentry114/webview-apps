System.register("q-bundled:///fs/cocos/asset/asset-manager/asset-manager.js", ["../../../../virtual/internal%253Aconstants.js", "../../core/index.js", "./bundle.js", "./cache.js", "./cache-manager.js", "./depend-util.js", "./downloader.js", "./factory.js", "./fetch.js", "./helper.js", "./load.js", "./pack-manager.js", "./parser.js", "./pipeline.js", "./preprocess.js", "./release-manager.js", "./request-item.js", "./shared.js", "./task.js", "./url-transformer.js", "./utilities.js"], function (_export, _context) {
  ...
  var BUILD, EDITOR, PREVIEW, error, sys, Settings, settings, path, cclegacy, Bundle, Cache, CacheManager, dependUtil, DependUtil, downloader, Downloader, factory, fetch, helper, load, packManager, parser, Parser, Pipeline, preprocess, releaseManager, RequestItem, presets, references, assets, BuiltinBundleName, bundles, fetchPipeline, files, parsed, pipeline, transformPipeline, assetsOverrideMap, Task, combine, parse, replaceOverrideAsset, asyncify, parseParameters, AssetManager, assetManager;
    ...
    execute: function () {
      ...
      _export("AssetManager", AssetManager = class AssetManager {
        ...
        constructor() {
          ...
          this.allowImageBitmap = !EDITOR && !sys.isMobile;
          this.utils = helper;
