System.register("q-bundled:///fs/cocos/spine/skeleton-cache.js", ["./track-entry-listeners.js", "./lib/spine-core.js"], function (_export, _context) {
  ...
  var TrackEntryListeners, spine, AnimationCache, SkeletonCache, MaxCacheTime, FrameTime, _vertices, _indices, _boneInfoOffset, _indexOffset, _vfOffset, _preTexID, _preBlendMode, _segVCount, _segICount, _segOffset, _colorOffset, _preFinalColor, _preDarkColor, PerVertexSize, PerClipVertexSize, ExportVertexSize, _vfCount, _indexCount, _tempr, _tempg, _tempb, _tempa, _finalColor32, _darkColor32, _finalColor, _darkColor, _quadTriangles;

  function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

  _export("AnimationCache", void 0);
      ...
      _export("AnimationCache", AnimationCache = class AnimationCache {
        ...
        fillVertices(skeletonColor, attachmentColor, slotColor, clipper, slot) {
          ...
          if (!clipper.isClipping()) {
            ...
            clipper.clipTriangles(_vertices, _vfCount, subIndices, _indexCount, _vertices, _finalColor, _darkColor, true, PerVertexSize, _vfOffset, _vfOffset + 2);
