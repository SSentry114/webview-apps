System.register("q-bundled:///fs/cocos/rendering/reflection-probe/reflection-probe-flow.js", ["../../../../virtual/internal%253Aconstants.js", "../../core/data/decorators/index.js", "../render-flow.js", "./reflection-probe-stage.js", "../pipeline-serialization.js", "../../render-scene/scene/index.js", "../../core/index.js"], function (_export, _context) {
  "use strict";

  var EDITOR, ccclass, RenderFlow, ReflectionProbeStage, RenderFlowTag, ProbeType, cclegacy, _dec, _class, _class2, _temp, ReflectionProbeFlow;
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("ReflectionProbeFlow", ReflectionProbeFlow = (_dec = ccclass('ReflectionProbeFlow'), _dec(_class = (_temp = _class2 = class ReflectionProbeFlow extends RenderFlow {
        initialize(info) {
          ...
          for (let i = 0; i < this._stages.length; i++) {
            ...
            if (probe.probeType === ProbeType.PLANAR) {
              ...
              for (let faceIdx = 0; faceIdx < 6; faceIdx++) {
                ...
                if (!renderTexture) return; //update camera dirction
