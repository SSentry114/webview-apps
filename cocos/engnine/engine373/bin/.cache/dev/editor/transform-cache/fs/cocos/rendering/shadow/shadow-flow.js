System.register("q-bundled:///fs/cocos/rendering/shadow/shadow-flow.js", ["../../core/data/decorators/index.js", "../define.js", "../render-flow.js", "../enum.js", "./shadow-stage.js", "../../gfx/index.js", "../pipeline-serialization.js", "../../render-scene/scene/shadows.js", "../../render-scene/scene/light.js"], function (_export, _context) {
  ...
  var ccclass, PIPELINE_FLOW_SHADOW, supportsR32FloatTexture, UBOCamera, UBOCSM, UBOGlobal, UBOShadow, RenderFlow, ForwardFlowPriority, ShadowStage, LoadOp, StoreOp, Format, TextureType, TextureUsageBit, ColorAttachment, DepthStencilAttachment, RenderPassInfo, TextureInfo, FramebufferInfo, API, RenderFlowTag, PCFType, ShadowType, LightType, _dec, _class, _class2, _temp, _validLights, ShadowFlow;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ShadowFlow", ShadowFlow = (_dec = ccclass('ShadowFlow'), _dec(_class = (_temp = _class2 = class ShadowFlow extends RenderFlow {
        constructor(...args) {
          super(...args);
        ...
        activate(pipeline) {
          super.activate(pipeline); // 0: SHADOWMAP_FLOAT, 1: SHADOWMAP_RGBE.

          const isRGBE = supportsR32FloatTexture(pipeline.device) ? 0 : 1;
          pipeline.macros.CC_SHADOWMAP_FORMAT = isRGBE; // 0: SHADOWMAP_LINER_DEPTH_OFF, 1: SHADOWMAP_LINER_DEPTH_ON.

          const isLinear = pipeline.device.gfxAPI === API.WEBGL ? 1 : 0;
          pipeline.macros.CC_SHADOWMAP_USE_LINEAR_DEPTH = isLinear; // 0: UNIFORM_VECTORS_LESS_EQUAL_64, 1: UNIFORM_VECTORS_GREATER_EQUAL_125.
          ...
          pipeline.macros.CC_SUPPORT_CASCADED_SHADOW_MAP = pipeline.pipelineSceneData.csmSupported; // 0: CC_SHADOW_NONE, 1: CC_SHADOW_PLANAR, 2: CC_SHADOW_MAP

          pipeline.macros.CC_SHADOW_TYPE = 0; // 0: PCFType.HARD, 1: PCFType.SOFT, 2: PCFType.SOFT_2X, 3: PCFType.SOFT_4X

          pipeline.macros.CC_DIR_SHADOW_PCF_TYPE = PCFType.HARD; // 0: CC_DIR_LIGHT_SHADOW_NONE, 1: CC_DIR_LIGHT_SHADOW_UNIFORM, 2: CC_DIR_LIGHT_SHADOW_CASCADED, 3: CC_DIR_LIGHT_SHADOW_VARIANCE

          pipeline.macros.CC_DIR_LIGHT_SHADOW_TYPE = 0; // 0: CC_CASCADED_LAYERS_TRANSITION_OFF, 1: CC_CASCADED_LAYERS_TRANSITION_ON
        ...
        _initShadowFrameBuffer(pipeline, light, swapchain) {
          ...
          const shadowFrameBuffer = device.createFramebuffer(new FramebufferInfo(this._shadowRenderPass, shadowRenderTargets, depth)); // Cache frameBuffer
