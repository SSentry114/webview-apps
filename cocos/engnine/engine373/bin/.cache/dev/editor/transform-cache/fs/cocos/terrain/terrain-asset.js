System.register("q-bundled:///fs/cocos/terrain/terrain-asset.js", ["../core/data/decorators/index.js", "../asset/assets/index.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TerrainLayerBinaryInfo", TerrainLayerBinaryInfo = (_dec2 = ccclass('cc.TerrainLayerBinaryInfo'), _dec2(_class4 = class TerrainLayerBinaryInfo {
        constructor() {
          this.slot = 0;
          this.tileSize = 1;
          this.roughness = 1;
      ...
      _export("TerrainAsset", TerrainAsset = (_dec3 = ccclass('cc.TerrainAsset'), _dec3(_class6 = (_class7 = class TerrainAsset extends Asset {
        constructor() {
          super();
          this._version = 0;
          this._data = null;
      ...
      }, (_initializer7 = _applyDecoratedInitializer(_class7.prototype, "_layerInfos", [serializable], function () {
        return [];
      })), _class7)) || _class6));
    }
  };
