System.register("q-bundled:///fs/cocos/core/data/utils/compact-value-type-array.js", ["../decorators/index.js", "../../math/index.js"], function (_export, _context) {
  ...
  var ccclass, serializable, Vec3, Quat, Vec4, Mat4, _dec, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _class3, _temp, StorageUnit, ElementType, elementTypeBits, CompactValueTypeArray, BuiltinElementTypeTraits;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("CompactValueTypeArray", CompactValueTypeArray = (_dec = ccclass('cc.CompactValueTypeArray'), _dec(_class = (_class2 = (_temp = _class3 = class CompactValueTypeArray {
        constructor() {
      ...
      }, _class3.StorageUnit = StorageUnit, _class3.ElementType = ElementType, _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "_byteOffset", [serializable], function () {
        return 0;
