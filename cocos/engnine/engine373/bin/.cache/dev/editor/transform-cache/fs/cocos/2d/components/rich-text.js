System.register("q-bundled:///fs/cocos/2d/components/rich-text.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../assets/index.js", "../../core/index.js", "../utils/text-utils.js", "../utils/html-text-parser.js", "../../scene-graph/index.js", "./label.js", "./label-outline.js", "./sprite.js", "../framework/index.js", "../../scene-graph/component.js", "../../scene-graph/node-event.js"], function (_export, _context) {
  "use strict";

  var ccclass, executeInEditMode, executionOrder, help, menu, tooltip, multiline, type, displayOrder, serializable, DEBUG, DEV, EDITOR, Font, SpriteAtlas, TTFFont, assert, warnID, Color, Vec2, CCObject, cclegacy, js, BASELINE_RATIO, fragmentText, isUnicodeCJK, isUnicodeSpace, getEnglishWordPartAtFirst, getEnglishWordPartAtLast, HtmlTextParser, Node, CacheMode, HorizontalTextAlignment, Label, VerticalTextAlignment, LabelOutline, Sprite, UITransform, Component, NodeEventType, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _initializer5, _initializer6, _initializer7, _initializer8, _initializer9, _initializer10, _initializer11, _initializer12, _initializer13, _class3, _temp, _htmlTextParser, RichTextChildName, RichTextChildImageName, _tempSize, _tempSizeLeft, labelPool, imagePool, RichText;
  ...
  return {
    ...
    execute: function () {
       ...
       * 富文本组件。
       */
      _export("RichText", RichText = (_dec = ccclass('cc.RichText'), _dec2 = help('i18n:cc.RichText'), _dec3 = executionOrder(110), _dec4 = menu('2D/RichText'), _dec5 = tooltip('i18n:richtext.string'), _dec6 = type(HorizontalTextAlignment), _dec7 = tooltip('i18n:richtext.horizontal_align'), _dec8 = type(VerticalTextAlignment), _dec9 = tooltip('i18n:richtext.vertical_align'), _dec10 = tooltip('i18n:richtext.font_size'), _dec11 = tooltip('i18n:richtext.font_family'), _dec12 = type(Font), _dec13 = tooltip('i18n:richtext.font'), _dec14 = tooltip('i18n:richtext.use_system_font'), _dec15 = displayOrder(12), _dec16 = type(CacheMode), _dec17 = tooltip('i18n:richtext.cache_mode'), _dec18 = tooltip('i18n:richtext.max_width'), _dec19 = tooltip('i18n:richtext.line_height'), _dec20 = type(SpriteAtlas), _dec21 = tooltip('i18n:richtext.image_atlas'), _dec22 = tooltip('i18n:richtext.handleTouchEvent'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = executeInEditMode(_class = (_class2 = (_temp = _class3 = class RichText extends Component {
        /**
         * @en
        ...
        constructor() {
          ...
          this._maxWidth = _initializer6 && _initializer6();
          this._fontFamily = _initializer7 && _initializer7();
          this._font = _initializer8 && _initializer8();
          this._isSystemFontUsed = _initializer9 && _initializer9();
          this._userDefinedFont = _initializer10 && _initializer10();
          this._cacheMode = _initializer11 && _initializer11();
          this._imageAtlas = _initializer12 && _initializer12();
          this._handleTouchEvent = _initializer13 && _initializer13();
          this._textArray = [];
          this._segments = [];
        ...
        */
        ...
        splitLongStringApproximatelyIn2048(text, styleIndex) {
          ...
          const partStringArr = []; // avoid that many short richtext still execute _calculateSize so that performance is low
        ...
        */
        ...
        splitLongStringOver2048(text, styleIndex) {
          ...
          const sizeForOnePart = lineCountForOnePart * maxWidth; // divide text into some pieces of which the size is less than sizeForOnePart

          while (curStringSize.x > sizeForOnePart) {
            curEnd /= 2; // at least one char can be an entity, step back.
          ...
          let leftTryTimes = 1000; // the minimum step of expansion or reduction

          let curWordStep = 1;

          while (leftTryTimes && curStart < text.length) {
            while (leftTryTimes && curStringSize.x < sizeForOnePart) {
              const nextPartExec = getEnglishWordPartAtFirst(leftString); // add a character, unless there is a complete word at the beginning of the next line
            ...
            while (leftTryTimes && curString.length >= 2 && curStringSize.x > sizeForOnePart) {
              ...
              this._calculateSize(curStringSize, styleIndex, curString); // after the first reduction, the step should be 1.
            ...
            if (curString.length >= 2) {
              ...
              if (lastWordExec && lastWordExec.length > 0 // to avoid endless loop when there is only one word in this line
            ...
            leftTryTimes--; // Exit: If the left part string size is less than 2048, the method will finish.
        ...
        */
      ...
      }, _class3.HorizontalAlign = HorizontalTextAlignment, _class3.VerticalAlign = VerticalTextAlignment, _temp), (_applyDecoratedDescriptor(_class2.prototype, "string", [multiline, _dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "string"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "horizontalAlign", [_dec6, _dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "horizontalAlign"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "verticalAlign", [_dec8, _dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "verticalAlign"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "fontSize", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "fontSize"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "fontFamily", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "fontFamily"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "font", [_dec12, _dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "font"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "useSystemFont", [_dec14, _dec15], Object.getOwnPropertyDescriptor(_class2.prototype, "useSystemFont"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "cacheMode", [_dec16, _dec17], Object.getOwnPropertyDescriptor(_class2.prototype, "cacheMode"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "maxWidth", [_dec18], Object.getOwnPropertyDescriptor(_class2.prototype, "maxWidth"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "lineHeight", [_dec19], Object.getOwnPropertyDescriptor(_class2.prototype, "lineHeight"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "imageAtlas", [_dec20, _dec21], Object.getOwnPropertyDescriptor(_class2.prototype, "imageAtlas"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "handleTouchEvent", [_dec22], Object.getOwnPropertyDescriptor(_class2.prototype, "handleTouchEvent"), _class2.prototype), _initializer = _applyDecoratedInitializer(_class2.prototype, "_lineHeight", [serializable], function () {
        return 40;
        ...
        return 40;
      }), _initializer6 = _applyDecoratedInitializer(_class2.prototype, "_maxWidth", [serializable], function () {
        return 0;
      }), _initializer7 = _applyDecoratedInitializer(_class2.prototype, "_fontFamily", [serializable], function () {
        return 'Arial';
      }), _initializer8 = _applyDecoratedInitializer(_class2.prototype, "_font", [serializable], function () {
        return null;
      }), _initializer9 = _applyDecoratedInitializer(_class2.prototype, "_isSystemFontUsed", [serializable], function () {
        return true;
      }), _initializer10 = _applyDecoratedInitializer(_class2.prototype, "_userDefinedFont", [serializable], function () {
        return null;
      }), _initializer11 = _applyDecoratedInitializer(_class2.prototype, "_cacheMode", [serializable], function () {
        return CacheMode.NONE;
      }), _initializer12 = _applyDecoratedInitializer(_class2.prototype, "_imageAtlas", [serializable], function () {
        return null;
      }), _initializer13 = _applyDecoratedInitializer(_class2.prototype, "_handleTouchEvent", [serializable], function () {
        return true;
