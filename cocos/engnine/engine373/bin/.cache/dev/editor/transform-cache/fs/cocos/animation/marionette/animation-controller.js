System.register("q-bundled:///fs/cocos/animation/marionette/animation-controller.js", ["../../scene-graph/component.js", "./animation-graph.js", "../../core/index.js", "./graph-eval.js", "./animation-graph-variant.js", "./animation-graph-like.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("AnimationController", AnimationController = (_dec = ccclass('cc.animation.AnimationController'), _dec2 = menu('Animation/Animation Controller'), _dec3 = type(AnimationGraphLike), _dec4 = formerlySerializedAs('graph'), _dec(_class = _dec2(_class = (_class2 = class AnimationController extends Component {
        constructor(...args) {
          super(...args);
      ...
      }, (_applyDecoratedDescriptor(_class2.prototype, "graph", [_dec3, editable], Object.getOwnPropertyDescriptor(_class2.prototype, "graph"), _class2.prototype), _initializer = _applyDecoratedInitializer(_class2.prototype, "_graph", [serializable, _dec4], function () {
        return null;
