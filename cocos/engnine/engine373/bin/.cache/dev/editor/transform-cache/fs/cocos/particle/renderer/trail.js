System.register("q-bundled:///fs/cocos/particle/renderer/trail.js", ["../../core/data/decorators/index.js", "../../asset/assets/rendering-sub-mesh.js", "../../game/director.js", "../../gfx/index.js", "../../core/index.js", "../../render-scene/index.js", "../animator/curve-range.js", "../animator/gradient-range.js", "../enum.js", "../../scene-graph/node-enum.js"], function (_export, _context) {
  ...
  var ccclass, tooltip, displayOrder, type, serializable, range, RenderingSubMesh, director, AttributeName, BufferUsageBit, Format, FormatInfos, MemoryUsageBit, PrimitiveMode, Attribute, IndirectBuffer, BufferInfo, DrawInfo, DRAW_INFO_SIZE, Color, Mat4, Quat, toRadian, Vec3, Pool, warnID, cclegacy, scene, CurveRange, GradientRange, Space, TextureMode, TrailMode, TransformBit, TrailSegment, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _dec28, _dec29, _dec30, _dec31, _dec32, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _initializer5, _initializer6, _initializer7, _initializer8, _initializer9, _initializer10, _initializer11, _initializer12, _initializer13, PRE_TRIANGLE_INDEX, NEXT_TRIANGLE_INDEX, DIRECTION_THRESHOLD, _temp_trailEle, _temp_quat, _temp_xform, _temp_vec3, _temp_vec3_1, _temp_color, TrailModule;
  ...
  return {
    ...
    execute: function () {
      ...
      }, (_applyDecoratedDescriptor(_class2.prototype, "enable", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "enable"), _class2.prototype), _initializer = _applyDecoratedInitializer(_class2.prototype, "_enable", [serializable], function () {
        return false;
      }), _initializer2 = _applyDecoratedInitializer(_class2.prototype, "mode", [_dec3, serializable, _dec4, _dec5], function () {
        return TrailMode.Particles;
      }), _initializer3 = _applyDecoratedInitializer(_class2.prototype, "lifeTime", [_dec6, serializable, _dec7, _dec8, _dec9], function () {
        return new CurveRange();
      }), _initializer4 = _applyDecoratedInitializer(_class2.prototype, "_minParticleDistance", [serializable], function () {
        return 0.1;
      }), _applyDecoratedDescriptor(_class2.prototype, "minParticleDistance", [_dec10, _dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "minParticleDistance"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "space", [_dec12, _dec13, _dec14], Object.getOwnPropertyDescriptor(_class2.prototype, "space"), _class2.prototype), _initializer5 = _applyDecoratedInitializer(_class2.prototype, "existWithParticles", [serializable], function () {
        return true;
      }), _initializer6 = _applyDecoratedInitializer(_class2.prototype, "textureMode", [_dec15, serializable, _dec16, _dec17], function () {
        return TextureMode.Stretch;
      }), _initializer7 = _applyDecoratedInitializer(_class2.prototype, "widthFromParticle", [serializable, _dec18, _dec19], function () {
        return true;
      }), _initializer8 = _applyDecoratedInitializer(_class2.prototype, "widthRatio", [_dec20, serializable, _dec21, _dec22, _dec23], function () {
        return new CurveRange();
      }), _initializer9 = _applyDecoratedInitializer(_class2.prototype, "colorFromParticle", [serializable, _dec24, _dec25], function () {
        return false;
      }), _initializer10 = _applyDecoratedInitializer(_class2.prototype, "colorOverTrail", [_dec26, serializable, _dec27, _dec28], function () {
        return new GradientRange();
      }), _initializer11 = _applyDecoratedInitializer(_class2.prototype, "colorOvertime", [_dec29, serializable, _dec30, _dec31], function () {
        return new GradientRange();
      }), _initializer12 = _applyDecoratedInitializer(_class2.prototype, "_space", [_dec32], function () {
        return Space.World;
      }), _initializer13 = _applyDecoratedInitializer(_class2.prototype, "_particleSystem", [serializable], function () {
        return null;
      })), _class2)) || _class));
    }
  };
