    ...
    execute: function () {
      ...
      _export("Tetrahedron", Tetrahedron = (_dec3 = ccclass('cc.Tetrahedron'), _dec3(_class11 = (_class12 = class Tetrahedron {
        ...
        constructor(delaunay, v0, v1, v2, v3 = -1) {
          ...
          this.vertex1 = v1;
          this.vertex2 = v2;
          this.vertex3 = v3; // inner tetrahedron
      ...
      _export("Delaunay", Delaunay = class Delaunay {
        ...
        tetrahedralize() {
          ...
          const probeCount = this._probes.length; // init a super tetrahedron containing all probes
        ...
        computeAdjacency() {
          ...
          for (let i = 0; i < triangleIndex; i++) {
            ...
            if (this._triangles[i].isOuterFace) {
              ...
              Vec3.add(probe2.normal, probe2.normal, normal); // create an outer cell with normal facing out
              ...
              const tetrahedron = new Tetrahedron(this, v0, v1, v2); // update adjacency between tetrahedron and outer cell
        ...
        computeOuterCellMatrix(tetrahedron) {
          ...
          m[11] = 0.0;
          m[11] -= _p2.x * m[2] + _p2.y * m[5] + _p2.z * m[8]; // coefficient of t^3
          ...
          tetrahedron.matrix.set(m[0], m[1], m[2], m[3], m[4], m[5], m[6], m[7], m[8]); // last column of mat3x4
