System.register("q-bundled:///fs/cocos/particle/renderer/particle-system-renderer-gpu.js", ["../../../../virtual/internal%253Aconstants.js", "../../asset/asset-manager/index.js", "../../gfx/index.js", "../../core/index.js", "../../render-scene/core/material-instance.js", "../enum.js", "../particle.js", "../animator/gradient-range.js", "../../render-scene/core/pass.js", "../animator/curve-range.js", "./particle-system-renderer-base.js"], function (_export, _context) {
  ...
  var EDITOR, builtinResMgr, AttributeName, Format, Attribute, API, deviceManager, FormatInfos, Mat4, Vec2, Vec4, Quat, Vec3, cclegacy, MaterialInstance, AlignmentSpace, RenderMode, Space, Particle, packGradientRange, Pass, packCurveRangeXYZ, packCurveRangeZ, packCurveRangeXYZW, packCurveRangeN, packCurveRangeXY, ParticleSystemRendererBase, ParticleSystemRendererGPU, _tempWorldTrans, _tempVec4, _world_rot, _node_rot, _node_euler, _sample_num, _sample_interval, CC_USE_WORLD_SPACE, CC_RENDER_MODE, RENDER_MODE_BILLBOARD, RENDER_MODE_STRETCHED_BILLBOARD, RENDER_MODE_HORIZONTAL_BILLBOARD, RENDER_MODE_VERTICAL_BILLBOARD, RENDER_MODE_MESH, COLOR_OVER_TIME_MODULE_ENABLE, ROTATION_OVER_TIME_MODULE_ENABLE, SIZE_OVER_TIME_MODULE_ENABLE, VELOCITY_OVER_TIME_MODULE_ENABLE, FORCE_OVER_TIME_MODULE_ENABLE, TEXTURE_ANIMATION_MODULE_ENABLE, USE_VK_SHADER, INSTANCE_PARTICLE, _vert_attr_name, _gpu_vert_attr, _gpu_vert_attr_mesh, _gpu_vert_attr_ins, _gpu_vert_attr_mesh_ins, _matInsInfo;
  ...
  return {
    ...
    execute: function () {
      ...
      _gpu_vert_attr_mesh_ins = [new Attribute(_vert_attr_name.POSITION_STARTTIME, Format.RGBA32F, false, 0, true), new Attribute(_vert_attr_name.VERT_SIZE_FID, Format.RGBA32F, false, 0, true), new Attribute(_vert_attr_name.VERT_ROTATION, Format.RGB32F, false, 0, true), new Attribute(_vert_attr_name.COLOR, Format.RGBA32F, false, 0, true), new Attribute(_vert_attr_name.DIR_LIFE, Format.RGBA32F, false, 0, true), new Attribute(_vert_attr_name.RANDOM_SEED, Format.R32F, false, 0, true), new Attribute(AttributeName.ATTR_TEX_COORD, Format.RGB32F, false, 1), // mesh uv
