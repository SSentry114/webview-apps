    ...
    execute: function () {
      ...
      _export("ParticleNoise", ParticleNoise = class ParticleNoise {
        ...
        getNoiseParticle() {
          ...
          const axisOffset = 1000.0; // eslint-disable-next-line max-len

          const sampX = this.getNoise(this.point.z + this.accSpeed.x, this.point.y, this.point.x, this.dt, this.accSpeed, this.noiseFrequency, this.octaves); // eslint-disable-next-line max-len

          const sampY = this.getNoise(this.point.x + axisOffset, this.point.z + this.accSpeed.y, this.point.y, this.dt, this.accSpeed, this.noiseFrequency, this.octaves); // eslint-disable-next-line max-len
