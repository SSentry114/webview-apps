System.register("q-bundled:///fs/cocos/terrain/terrain.js", ["../core/data/decorators/index.js", "../asset/asset-manager/index.js", "../misc/model-renderer.js", "../asset/assets/index.js", "../asset/assets/asset-enum.js", "../asset/assets/material.js", "../asset/assets/rendering-sub-mesh.js", "../scene-graph/component.js", "../core/data/object.js", "../game/director.js", "../gfx/index.js", "../core/math/index.js", "../render-scene/index.js", "../core/global-exports.js", "./terrain-lod.js", "./terrain-asset.js", "../core/index.js", "../rendering/index.js", "../scene-graph/index.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TerrainBlockLightmapInfo", TerrainBlockLightmapInfo = (_dec3 = ccclass('cc.TerrainBlockLightmapInfo'), _dec3(_class7 = (_class8 = class TerrainBlockLightmapInfo {
        constructor() {
      ...
      }, (_initializer10 = _applyDecoratedInitializer(_class8.prototype, "texture", [serializable, editable], function () {
        return null;
      }), _initializer11 = _applyDecoratedInitializer(_class8.prototype, "UOff", [serializable, editable], function () {
        return 0;
      }), _initializer12 = _applyDecoratedInitializer(_class8.prototype, "VOff", [serializable, editable], function () {
        return 0;
      }), _initializer13 = _applyDecoratedInitializer(_class8.prototype, "UScale", [serializable, editable], function () {
        return 0;
      }), _initializer14 = _applyDecoratedInitializer(_class8.prototype, "VScale", [serializable, editable], function () {
        return 0;
      })), _class8)) || _class7));
      /**
       * @en Terrain block
      ...
      _export("TerrainBlock", TerrainBlock = class TerrainBlock {
        ...
        build() {
          const gfxDevice = director.root.device; // vertex buffer
          ...
          vertexBuffer.update(vertexData); // build bounding box

          this._buildBoundingBox(); // initialize renderable
        ...
        _buildLodInfo() {
          ...
          this._buildVertexData(vertexData); // update lod
      ...
      _export("Terrain", Terrain = (_dec4 = ccclass('cc.Terrain'), _dec5 = help('i18n:cc.Terrain'), _dec6 = type(TerrainAsset), _dec7 = type(EffectAsset), _dec8 = visible(false), _dec9 = type(TerrainBlockLightmapInfo), _dec10 = type(CCFloat), _dec11 = type(TerrainAsset), _dec12 = visible(true), _dec13 = type(EffectAsset), _dec14 = visible(true), _dec15 = type(TerrainInfo), _dec4(_class10 = _dec5(_class10 = executeInEditMode(_class10 = disallowMultiple(_class10 = (_class11 = class Terrain extends Component {
        ...
        rebuild(info) {
          ...
          this._blocks = []; // reset lightmap

          this._resetLightmap(false); // build layer buffer


          this._rebuildLayerBuffer(info); // build heights and normals


          const heightsChanged = this._rebuildHeights(info); // build weights
          ...
          this._blockCount[1] = info.blockCount[1];
          this._weightMapSize = info.weightMapSize;
          this._lightMapSize = info.lightMapSize; // build normals if heights changed
          ...
          if (this._lod !== null) {
            ...
            for (let j = 0; j < TERRAIN_BLOCK_TILE_COMPLEXITY; ++j) {
              for (let i = 0; i < TERRAIN_BLOCK_TILE_COMPLEXITY; ++i) {
                ...
                const d = (j + 1) * TERRAIN_BLOCK_VERTEX_COMPLEXITY + i + 1; // face 1
      ...
      }, (_initializer15 = _applyDecoratedInitializer(_class11.prototype, "__asset", [_dec6, serializable, disallowAnimation], function () {
        return null;
      }), _initializer16 = _applyDecoratedInitializer(_class11.prototype, "_effectAsset", [_dec7, serializable, disallowAnimation, _dec8], function () {
        return null;
      }), _initializer17 = _applyDecoratedInitializer(_class11.prototype, "_lightmapInfos", [_dec9, serializable, disallowAnimation], function () {
        return [];
      }), _initializer18 = _applyDecoratedInitializer(_class11.prototype, "_receiveShadow", [serializable, disallowAnimation], function () {
        return false;
      }), _initializer19 = _applyDecoratedInitializer(_class11.prototype, "_useNormalmap", [serializable, disallowAnimation], function () {
        return false;
      }), _initializer20 = _applyDecoratedInitializer(_class11.prototype, "_usePBR", [serializable, disallowAnimation], function () {
        return false;
      }), _initializer21 = _applyDecoratedInitializer(_class11.prototype, "_lodEnable", [serializable, disallowAnimation], function () {
        return false;
      }), _initializer22 = _applyDecoratedInitializer(_class11.prototype, "_lodBias", [_dec10, serializable, disallowAnimation], function () {
        return 0;
      }), _applyDecoratedDescriptor(_class11.prototype, "_asset", [_dec11, _dec12], Object.getOwnPropertyDescriptor(_class11.prototype, "_asset"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "effectAsset", [_dec13, _dec14], Object.getOwnPropertyDescriptor(_class11.prototype, "effectAsset"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "receiveShadow", [editable], Object.getOwnPropertyDescriptor(_class11.prototype, "receiveShadow"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "useNormalMap", [editable], Object.getOwnPropertyDescriptor(_class11.prototype, "useNormalMap"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "usePBR", [editable], Object.getOwnPropertyDescriptor(_class11.prototype, "usePBR"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "lodEnable", [editable], Object.getOwnPropertyDescriptor(_class11.prototype, "lodEnable"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "LodBias", [editable], Object.getOwnPropertyDescriptor(_class11.prototype, "LodBias"), _class11.prototype), _applyDecoratedDescriptor(_class11.prototype, "info", [_dec15], Object.getOwnPropertyDescriptor(_class11.prototype, "info"), _class11.prototype)), _class11)) || _class10) || _class10) || _class10) || _class10));
    }
  };
});