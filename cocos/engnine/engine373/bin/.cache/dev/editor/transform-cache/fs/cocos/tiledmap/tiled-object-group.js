        ...
        _init(groupInfo, mapInfo, texGrids) {
          ...
          for (let i = 0, l = objects.length; i < l; i++) {
            ...
            if (objType === TMXObjectType.TEXT) {
              ...
              sprite.sizeMode = Sprite.SizeMode.CUSTOM; // HACK: we should support _premultiplyAlpha when group had material

              const srcBlendFactor = this._premultiplyAlpha ? BlendFactor.ONE : BlendFactor.SRC_ALPHA; // @ts-expect-error remove when ui-render remove blend
