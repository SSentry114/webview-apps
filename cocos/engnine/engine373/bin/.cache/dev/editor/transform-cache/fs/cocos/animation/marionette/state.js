System.register("q-bundled:///fs/cocos/animation/marionette/state.js", ["./ownership.js", "../../core/index.js", "../define.js", "../../serialization/instantiate.js", "./animation-graph-editor-extras-clone-helper.js"], function (_export, _context) {
  "use strict";
      ...
      _export("InteractiveState", InteractiveState = (_dec2 = ccclass(`${CLASS_NAME_PREFIX_ANIM}InteractiveState`), _dec2(_class4 = (_class5 = class InteractiveState extends State {
        ...
        instantiateComponents() {
          const instantiatedComponents = this._components.map(component => {
            ...
            const instantiated = instantiate(component, true);
            return instantiated;
          });
