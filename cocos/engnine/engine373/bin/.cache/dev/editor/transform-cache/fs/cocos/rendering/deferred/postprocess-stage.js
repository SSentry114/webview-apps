System.register("q-bundled:///fs/cocos/rendering/deferred/postprocess-stage.js", ["../../core/data/decorators/index.js", "../define.js", "../../gfx/index.js", "../render-stage.js", "../enum.js", "../../asset/assets/material.js", "../pipeline-state-manager.js", "../pipeline-serialization.js", "../pipeline-funcs.js", "../ui-phase.js"], function (_export, _context) {
  ...
  var ccclass, displayOrder, type, serializable, SetIndex, UBOLocal, Color, Rect, ClearFlagBit, DescriptorSetInfo, BufferInfo, BufferUsageBit, MemoryUsageBit, RenderStage, CommonStagePriority, Material, PipelineStateManager, RenderQueueDesc, renderProfiler, UIPhase, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _initializer, _initializer2, _class3, _temp, colors, PostProcessStage;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("PostProcessStage", PostProcessStage = (_dec = ccclass('PostProcessStage'), _dec2 = type(Material), _dec3 = displayOrder(3), _dec4 = type([RenderQueueDesc]), _dec5 = displayOrder(2), _dec(_class = (_class2 = (_temp = _class3 = class PostProcessStage extends RenderStage {
        constructor() {
          super();
        ...
        tag: 0
      }, _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "_postProcessMaterial", [_dec2, serializable, _dec3], function () {
        return null;
