System.register("q-bundled:///fs/cocos/asset/assets/image-asset.jsb.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../gfx/index.js", "./asset-enum.js", "../../core/index.js", "./asset.js"], function (_export, _context) {
  "use strict";

  var ccclass, override, ALIPAY, XIAOMI, JSB, TEST, BAIDU, Format, FormatFeatureBit, deviceManager, PixelFormat, sys, macro, warnID, cclegacy, ImageAsset, jsbWindow, extnames, imageAssetProto, superDestroy, ImageAssetProto, _nativeAssetDescriptor;
  ...
  return {
    ...
    execute: function () {
      ...
      imageAssetProto._deserialize = function (data) {
        ...
        let preferedExtensionIndex = Number.MAX_VALUE; // let format = this._format;
        ...
        for (const extensionID of extensionIDs) {
          ...
          const i = parseInt(extFormat[0], undefined); // const tmpExt = ImageAsset.extnames[i] || extFormat[0];
          ...
          if (index !== -1 && index < preferedExtensionIndex) {
            ...
            const fmt = extFormat[1] ? parseInt(extFormat[1]) : this.format; // check whether or not support compressed texture
        ...
        if (ext) {
          ...
          this.format = format; // this._format = format;
        } else {
          warnID(3121);
        }
      };

      cclegacy.ImageAsset = jsb.ImageAsset; // handle meta data, it is generated automatically

      ImageAssetProto = ImageAsset.prototype;
      _nativeAssetDescriptor = Object.getOwnPropertyDescriptor(ImageAssetProto, '_nativeAsset');
