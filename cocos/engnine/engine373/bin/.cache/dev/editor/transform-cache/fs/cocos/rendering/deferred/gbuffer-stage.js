System.register("q-bundled:///fs/cocos/rendering/deferred/gbuffer-stage.js", ["../../core/data/decorators/index.js", "../define.js", "../pass-phase.js", "../render-queue.js", "../../gfx/index.js", "../pipeline-funcs.js", "../render-batched-queue.js", "../render-instanced-queue.js", "../render-stage.js", "../enum.js", "../../render-scene/core/pass.js", "../pipeline-serialization.js"], function (_export, _context) {
  "use strict";

  var ccclass, displayOrder, type, serializable, SetIndex, getPhaseID, renderQueueClearFunc, convertRenderQueue, renderQueueSortFunc, ClearFlagBit, Color, Rect, SRGBToLinear, RenderBatchedQueue, RenderInstancedQueue, RenderStage, DeferredStagePriority, BatchingSchemes, RenderQueueDesc, RenderQueueSortMode, _dec, _dec2, _dec3, _class, _class2, _initializer, _class3, _temp, colors, GbufferStage;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GbufferStage", GbufferStage = (_dec = ccclass('GbufferStage'), _dec2 = type([RenderQueueDesc]), _dec3 = displayOrder(2), _dec(_class = (_class2 = (_temp = _class3 = class GbufferStage extends RenderStage {
        constructor() {
          super();
