System.register("q-bundled:///fs/cocos/physics-2d/box2d/rigid-body.js", ["@cocos/box2d", "../framework/physics-system.js", "../../core/index.js", "../framework/physics-types.js", "../../scene-graph/node.js", "../framework/index.js"], function (_export, _context) {
  ...
  var b2, PhysicsSystem2D, Vec2, toRadian, Vec3, Quat, toDegree, TWO_PI, HALF_PI, PHYSICS_2D_PTM_RATIO, ERigidBody2DType, Node, Collider2D, b2RigidBody2D, tempVec3, tempVec2_1;
    ...
    execute: function () {
      ...
      _export("b2RigidBody2D", b2RigidBody2D = class b2RigidBody2D {
        ...
        animate(dt) {
          ...
          b2body.SetLinearVelocity(tempVec2_1); //convert b2Rotation to [-PI~PI], which is the same as this._animatedAngle
