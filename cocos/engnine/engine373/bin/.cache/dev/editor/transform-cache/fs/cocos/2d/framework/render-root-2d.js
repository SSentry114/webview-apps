System.register("q-bundled:///fs/cocos/2d/framework/render-root-2d.js", ["../../core/data/decorators/index.js", "../../scene-graph/component.js", "../../core/index.js", "./ui-transform.js"], function (_export, _context) {
  ...
  var ccclass, disallowMultiple, executeInEditMode, executionOrder, menu, requireComponent, Component, cclegacy, UITransform, _dec, _dec2, _dec3, _dec4, _class, RenderRoot2D;
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("RenderRoot2D", RenderRoot2D = (_dec = ccclass('cc.RenderRoot2D'), _dec2 = executionOrder(100), _dec3 = menu('2D/RenderRoot2D'), _dec4 = requireComponent(UITransform), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = disallowMultiple(_class = executeInEditMode(_class = class RenderRoot2D extends Component {
        onEnable() {
