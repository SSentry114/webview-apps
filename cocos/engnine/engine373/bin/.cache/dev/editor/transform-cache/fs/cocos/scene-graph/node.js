System.register("q-bundled:///fs/cocos/scene-graph/node.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "./layers.js", "./node-ui-properties.js", "../core/global-exports.js", "./node-dev.js", "../core/math/index.js", "./node-enum.js", "../core/data/index.js", "../core/platform/debug.js", "./component.js", "../core/data/decorators/property.js", "../core/index.js", "./node-event.js"], function (_export, _context) {
  ...
  var ccclass, editable, serializable, type, DEV, DEBUG, EDITOR, Layers, NodeUIProperties, legacyCC, nodePolyfill, approx, EPSILON, Mat3, Mat4, Quat, Vec3, MobilityMode, NodeSpace, TransformBit, editorExtrasTag, serializeTag, errorID, warnID, error, log, getError, Component, property, CCObject, js, NodeEventType, _dec, _dec2, _dec3, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _initializer5, _initializer6, _initializer7, _initializer8, _initializer9, _initializer10, _initializer11, _class3, _temp, Destroying, DontDestroy, Deactivating, TRANSFORM_ON, idGenerator, v3_a, v3_b, q_a, q_b, qt_1, m3_1, m3_scaling, m4_1, m4_2, dirtyNodes, reserveContentsForAllSyncablePrefabTag, globalFlagChangeVersion, Node;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Node", Node = (_dec = ccclass('cc.Node'), _dec2 = type(Vec3), _dec3 = type(MobilityMode), _dec(_class = (_class2 = (_temp = _class3 = class Node extends CCObject {
        // --------------------- legacy BaseNode ---------------------
        ...
        static _findComponent(node, constructor) {
          ...
          const comps = node._components; // @ts-expect-error internal rtti property
        ...
        constructor(name) {
          ...
          this._transformFlags = TransformBit.NONE;
      ...
      }, _class3.idGenerator = idGenerator, _class3._stacks = [[]], _class3._stackId = 0, _class3.EventType = NodeEventType, _class3.NodeSpace = NodeSpace, _class3.TransformDirtyBit = TransformBit, _class3.TransformBit = TransformBit, _class3.reserveContentsForAllSyncablePrefabTag = reserveContentsForAllSyncablePrefabTag, _class3.ClearFrame = 0, _class3.ClearRound = 1000, _temp), (_applyDecoratedDescriptor(_class2.prototype, "_persistNode", [property], Object.getOwnPropertyDescriptor(_class2.prototype, "_persistNode"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "name", [editable], Object.getOwnPropertyDescriptor(_class2.prototype, "name"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "children", [editable], Object.getOwnPropertyDescriptor(_class2.prototype, "children"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "active", [editable], Object.getOwnPropertyDescriptor(_class2.prototype, "active"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "activeInHierarchy", [editable], Object.getOwnPropertyDescriptor(_class2.prototype, "activeInHierarchy"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "parent", [editable], Object.getOwnPropertyDescriptor(_class2.prototype, "parent"), _class2.prototype), _initializer = _applyDecoratedInitializer(_class2.prototype, "_parent", [serializable], function () {
        return null;
