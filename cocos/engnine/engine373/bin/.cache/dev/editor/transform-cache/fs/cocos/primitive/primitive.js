System.register("q-bundled:///fs/cocos/primitive/primitive.js", ["../core/data/decorators/index.js", "../3d/misc/index.js", "../3d/assets/mesh.js", "./index.js", "../core/index.js"], function (_export, _context) {
  ...
  var ccclass, type, serializable, editable, createMesh, Mesh, primitives, ccenum, cclegacy, _dec, _dec2, _class, _class2, _initializer, _initializer2, _class3, _temp, PrimitiveType, Primitive;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Primitive", Primitive = (_dec = ccclass('cc.Primitive'), _dec2 = type(PrimitiveType), _dec(_class = (_class2 = (_temp = _class3 = class Primitive extends Mesh {
        /**
         * @en
      ...
      }, _class3.PrimitiveType = PrimitiveType, _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "type", [_dec2], function () {
