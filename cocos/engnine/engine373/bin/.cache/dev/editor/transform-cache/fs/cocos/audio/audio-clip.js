System.register("q-bundled:///fs/cocos/audio/audio-clip.js", ["../core/data/decorators/index.js", "pal/audio", "../asset/assets/asset.js", "../core/index.js", "../../pal/audio/type.js"], function (_export, _context) {
  ...
  var ccclass, serializable, override, AudioPlayer, Asset, cclegacy, AudioState, AudioType, _dec, _class, _class2, _initializer, _class3, _temp, AudioClip;
  ...
  return {
    ...
    execute: function () {
       ...
       * 音频片段资源。
       */
      _export("AudioClip", AudioClip = (_dec = ccclass('cc.AudioClip'), _dec(_class = (_class2 = (_temp = _class3 = class AudioClip extends Asset {
        constructor(...args) {
          super(...args);
      ...
      }, _class3.AudioType = AudioType, _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "_duration", [serializable], function () {
        return 0;
