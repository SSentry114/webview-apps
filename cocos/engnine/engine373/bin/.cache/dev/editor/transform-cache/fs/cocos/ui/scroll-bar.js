System.register("q-bundled:///fs/cocos/ui/scroll-bar.js", ["../core/data/decorators/index.js", "../scene-graph/component.js", "../2d/framework/index.js", "../core/math/index.js", "../core/value-types/enum.js", "../core/math/utils.js", "../2d/components/sprite.js", "../core/global-exports.js"], function (_export, _context) {
  ...
  var ccclass, help, executionOrder, menu, requireComponent, tooltip, displayOrder, type, serializable, Component, UITransform, Color, Vec2, Vec3, ccenum, clamp01, Sprite, legacyCC, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _initializer5, _class3, _temp, GETTING_SHORTER_FACTOR, _tempPos_1, _tempPos_2, _tempVec3, defaultAnchor, _tempColor, _tempVec2, Direction, ScrollBar;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ScrollBar", ScrollBar = (_dec = ccclass('cc.ScrollBar'), _dec2 = help('i18n:cc.ScrollBar'), _dec3 = executionOrder(110), _dec4 = menu('UI/ScrollBar'), _dec5 = requireComponent(UITransform), _dec6 = type(Sprite), _dec7 = displayOrder(0), _dec8 = tooltip('i18n:scrollbar.handle'), _dec9 = type(Direction), _dec10 = displayOrder(1), _dec11 = tooltip('i18n:scrollbar.direction'), _dec12 = displayOrder(2), _dec13 = tooltip('i18n:scrollbar.auto_hide'), _dec14 = displayOrder(3), _dec15 = tooltip('i18n:scrollbar.auto_hide_time'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = _class3 = class ScrollBar extends Component {
        constructor(...args) {
          super(...args);
        ...
        show() {
          this._autoHideRemainingTime = this._autoHideTime; // because scrollbar's onEnable is later than scrollView, its _opacity is be modified in onEnable. we should reset it.
