System.register("q-bundled:///fs/cocos/render-scene/core/pass.js", ["../../../../virtual/internal%253Aconstants.js", "../../asset/asset-manager/builtin-res-mgr.js", "../../rendering/pass-phase.js", "../../core/index.js", "../../gfx/index.js", "./program-lib.js", "./pass-utils.js", "../../rendering/define.js", "../../rendering/instanced-buffer.js", "../../rendering/batched-buffer.js"], function (_export, _context) {
  ...
  return {
    ...
    }, function (_renderingBatchedBufferJs) {
      BatchedBuffer = _renderingBatchedBufferJs.BatchedBuffer;
    }],
    execute: function () {
      ...
      _export("Pass", Pass = class Pass {
        ...
        resetTexture(name, index) {
          ...
          const texName = value ? `${value}${getStringFromType(type)}` : getDefaultFromType(type);
        ...
        _doInit(info, copyDefines = false) {
          ...
          this._properties = info.properties || this._properties; // init gfx
          ...
          this._descriptorSet = this._device.createDescriptorSet(_dsInfo); // calculate total size required
