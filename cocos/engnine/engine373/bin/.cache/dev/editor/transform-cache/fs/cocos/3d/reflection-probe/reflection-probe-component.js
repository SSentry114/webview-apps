System.register("q-bundled:///fs/cocos/3d/reflection-probe/reflection-probe-component.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../core/index.js", "../../render-scene/index.js", "../../rendering/define.js", "../../rendering/reflection-probe-manager.js", "../../scene-graph/component.js", "../../scene-graph/layers.js", "../../misc/camera-component.js", "../../scene-graph/index.js", "../../render-scene/scene/reflection-probe.js", "../../physics/utils/util.js"], function (_export, _context) {
  "use strict";

  var ccclass, executeInEditMode, menu, playOnFocus, serializable, tooltip, type, visible, EDITOR, CCBoolean, cclegacy, CCObject, Color, Enum, Vec3, scene, CAMERA_DEFAULT_MASK, ReflectionProbeManager, Component, Layers, Camera, Node, TransformBit, ProbeClearFlag, ProbeType, absolute, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _initializer5, _initializer6, _initializer7, _initializer8, _initializer9, _initializer10, _class3, _temp, ProbeResolution, ReflectionProbe;
  ...
  return {
    ...
    }, function (_renderingReflectionProbeManagerJs) {
      ReflectionProbeManager = _renderingReflectionProbeManagerJs.ReflectionProbeManager;
    ...
    execute: function () {
      ...
      _export("ReflectionProbe", ReflectionProbe = (_dec = ccclass('cc.ReflectionProbe'), _dec2 = menu('Rendering/ReflectionProbe'), _dec3 = type(Vec3), _dec4 = type(Enum(ProbeType)), _dec5 = visible(function () {
        return this.probeType === ProbeType.CUBE;
      }), _dec6 = type(Enum(ProbeResolution)), _dec7 = type(Enum(ProbeClearFlag)), _dec8 = visible(function () {
        return this._clearFlag === ProbeClearFlag.SOLID_COLOR;
      }), _dec9 = type(Color), _dec10 = type(Layers.BitMask), _dec11 = tooltip('i18n:camera.visibility'), _dec12 = visible(function () {
        return this.probeType === ProbeType.PLANAR;
      }), _dec13 = type(Camera), _dec14 = visible(function () {
        return this.probeType === ProbeType.CUBE;
      }), _dec15 = type(CCBoolean), _dec16 = tooltip('i18n:reflection_probe.fastBake'), _dec(_class = _dec2(_class = executeInEditMode(_class = playOnFocus(_class = (_class2 = (_temp = _class3 = class ReflectionProbe extends Component {
        constructor(...args) {
          super(...args);
      ...
      }, _class3.DEFAULT_CUBE_SIZE = new Vec3(1, 1, 1), _class3.DEFAULT_PLANER_SIZE = new Vec3(5, 0.5, 5), _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "_resolution", [serializable], function () {
        return 256;
        ...
        return false;
      }), _applyDecoratedDescriptor(_class2.prototype, "size", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "size"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "probeType", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "probeType"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "resolution", [_dec5, _dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "resolution"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "clearFlag", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "clearFlag"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "backgroundColor", [_dec8, _dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "backgroundColor"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "visibility", [_dec10, _dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "visibility"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "sourceCamera", [_dec12, _dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "sourceCamera"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "fastBake", [_dec14, _dec15, _dec16], Object.getOwnPropertyDescriptor(_class2.prototype, "fastBake"), _class2.prototype)), _class2)) || _class) || _class) || _class) || _class));
    }
  };
});