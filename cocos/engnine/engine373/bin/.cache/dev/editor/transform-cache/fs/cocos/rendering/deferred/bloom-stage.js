System.register("q-bundled:///fs/cocos/rendering/deferred/bloom-stage.js", ["../../core/data/decorators/index.js", "../define.js", "../../asset/assets/material.js", "../../gfx/index.js", "../pipeline-state-manager.js", "../render-stage.js", "../enum.js", "../render-pipeline.js", "./deferred-pipeline-scene-data.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("BloomStage", BloomStage = (_dec = ccclass('BloomStage'), _dec2 = type(Material), _dec3 = displayOrder(3), _dec(_class = (_class2 = (_temp = _class3 = class BloomStage extends RenderStage {
        constructor() {
          super();
          this.threshold = 1.0;
          this.intensity = 0.8;
        ...
        tag: 0
      }, _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "_bloomMaterial", [_dec2, serializable, _dec3], function () {
        return null;
      })), _class2)) || _class));
    }
  };
