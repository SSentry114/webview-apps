      ...
      _export("LODGroup", LODGroup = (_dec6 = ccclass('cc.LODGroup'), _dec7 = menu('Rendering/LOD Group'), _dec8 = type(CCFloat), _dec9 = type([LOD]), _dec6(_class4 = _dec7(_class4 = executeInEditMode(_class4 = (_class5 = class LODGroup extends Component {
        ...
        recalculateBounds() {
          ...
          if (boundsMin) {
            ...
            const [minPos, maxPos] = getTransformedBoundary(c, e, this.node.worldMatrix.clone().invert()); // Set bounding volume center and extents in local space

            c.set((maxPos.x + minPos.x) * 0.5, (maxPos.y + minPos.y) * 0.5, (maxPos.z + minPos.z) * 0.5);
            e.set((maxPos.x - minPos.x) * 0.5, (maxPos.y - minPos.y) * 0.5, (maxPos.z - minPos.z) * 0.5); // Save the result
        ...
        resetObjectSize() {
          ...
          const scale = 1.0 / this.objectSize; // reset object size to 1
        ...
        onLoad() {
          this._lodGroup.node = this.node; // objectSize maybe initialized from deserialize
