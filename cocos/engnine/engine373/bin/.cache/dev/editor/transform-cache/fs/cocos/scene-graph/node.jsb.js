  ...
  return {
    ...
    execute: function () {
      ...
      nodeProto._onPreDestroy = function _onPreDestroy() {
        const ret = oldPreDestroy.call(this); // emit node destroy event (this should before event processor destroy)
      ...
      nodeProto._ctor = function (name) {
        ...
        const sharedArrayBuffer = this._getSharedArrayBufferObject(); // Uint32Array with 3 elements: eventMask, layer, dirtyFlags
