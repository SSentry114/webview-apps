System.register("q-bundled:///fs/cocos/3d/skeletal-animation/skeletal-animation.js", ["../../core/data/decorators/index.js", "../skinned-mesh-renderer/index.js", "../../core/index.js", "../../scene-graph/node.js", "../../animation/animation-component.js", "./skeletal-animation-data-hub.js", "./skeletal-animation-state.js", "../../animation/transform-utils.js", "../../animation/global-animation-manager.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("SkeletalAnimation", SkeletalAnimation = (_dec3 = ccclass('cc.SkeletalAnimation'), _dec4 = help('i18n:cc.SkeletalAnimation'), _dec5 = executionOrder(99), _dec6 = menu('Animation/SkeletalAnimation'), _dec7 = type([Socket]), _dec8 = tooltip('i18n:animation.sockets'), _dec9 = tooltip('i18n:animation.use_baked_animation'), _dec10 = type([Socket]), _dec3(_class4 = _dec4(_class4 = _dec5(_class4 = executeInEditMode(_class4 = _dec6(_class4 = (_class5 = (_temp = _class6 = class SkeletalAnimation extends Animation {
        constructor(...args) {
          super(...args);
        ...
        onLoad() {
          super.onLoad(); // Actively search for potential users and notify them that an animation is usable.
