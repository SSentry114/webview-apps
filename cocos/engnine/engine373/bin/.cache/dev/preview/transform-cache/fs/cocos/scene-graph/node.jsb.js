System.register("q-bundled:///fs/cocos/scene-graph/node.jsb.js", ["../../../virtual/internal%253Aconstants.js", "../core/data/decorators/index.js", "../core/global-exports.js", "../core/platform/debug.js", "./component.js", "./node-event.js", "../core/data/object.js", "./node-ui-properties.js", "./node-enum.js", "../core/math/index.js", "./layers.js", "../core/data/index.js", "./utils.jsb.js", "../core/utils/js-typed.js", "../core/utils/jsb-utils.js", "../core/data/class-decorator.js", "./node-dev.js", "../core/utils/js.js"], function (_export, _context) {
  "use strict";

  var EDITOR, ccclass, editable, serializable, type, legacyCC, errorID, getError, Component, NodeEventType, CCObject, NodeUIProperties, MobilityMode, NodeSpace, TransformBit, Mat4, Quat, Vec3, Layers, editorExtrasTag, serializeTag, _tempFloatArray, fillMat4WithTempFloatArray, getClassByName, isChildClassOf, syncNodeValues, property, nodePolyfill, js, reserveContentsForAllSyncablePrefabTag, Node, NodeCls, TRANSFORMBIT_TRS, nodeProto, TRANSFORM_ON, Destroying, REGISTERED_EVENT_MASK_TRANSFORM_CHANGED, REGISTERED_EVENT_MASK_PARENT_CHANGED, REGISTERED_EVENT_MASK_MOBILITY_CHANGED, REGISTERED_EVENT_MASK_LAYER_CHANGED, REGISTERED_EVENT_MASK_CHILD_REMOVED_CHANGED, REGISTERED_EVENT_MASK_CHILD_ADDED_CHANGED, REGISTERED_EVENT_MASK_SIBLING_ORDER_CHANGED_CHANGED, REGISTERED_EVENT_MASK_LIGHT_PROBE_BAKING_CHANGED, oldPreDestroy, _tempQuat, NodeProto, _persistNodeDescriptor, nameDescriptor, childrenDescriptor, activeDescriptor, activeInHierarchyDescriptor, parentDescriptor, eulerAnglesDescriptor, angleDescriptor, mobilityDescriptor, layerDescriptor;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Node", Node = jsb.Node); // @ts-ignore
      ...
      REGISTERED_EVENT_MASK_CHILD_REMOVED_CHANGED = 1 << 4;
      REGISTERED_EVENT_MASK_CHILD_ADDED_CHANGED = 1 << 5;
      REGISTERED_EVENT_MASK_SIBLING_ORDER_CHANGED_CHANGED = 1 << 6;
      REGISTERED_EVENT_MASK_LIGHT_PROBE_BAKING_CHANGED = 1 << 7;
      ...
      nodeProto._onNodeDestroyed = function () {
        this.emit(NodeEventType.NODE_DESTROYED, this); // destroy children
      ...
      nodeProto._onPreDestroy = function _onPreDestroy() {
        var ret = oldPreDestroy.call(this); // emit node destroy event (this should before event processor destroy)
      ...
      nodeProto._ctor = function (name) {
        ...
        var sharedArrayBuffer = this._getSharedArrayBufferObject(); // Uint32Array with 3 elements: eventMask, layer, dirtyFlags


        this._sharedUint32Arr = new Uint32Array(sharedArrayBuffer, 0, 3); // Int32Array with 1 element: siblingIndex

        this._sharedInt32Arr = new Int32Array(sharedArrayBuffer, 12, 1); // Uint8Array with 3 elements: activeInHierarchy, active, static
        ...
        this._scene = null;
        this._prefab = null; // record scene's id when set this node as persist node

        this._originalSceneId = '';

        this._registerListeners();

        this._children = []; // this._isChildrenRedefined = false;
        ...
        this.on(NodeEventType.CHILD_ADDED, function (child) {
          _this3._children.push(child);
        });
        this.on(NodeEventType.CHILD_REMOVED, function (child) {
          var removeAt = _this3._children.indexOf(child);
          ...
          _this3._children.splice(removeAt, 1);
        });
      ...
      _persistNodeDescriptor = Object.getOwnPropertyDescriptor(NodeProto, '_persistNode');
      property(NodeProto, '_persistNode', _persistNodeDescriptor);
      nameDescriptor = Object.getOwnPropertyDescriptor(NodeProto, 'name');
      editable(NodeProto, 'name', nameDescriptor);
      childrenDescriptor = Object.getOwnPropertyDescriptor(NodeProto, 'children');
      editable(NodeProto, 'children', childrenDescriptor);
      activeDescriptor = Object.getOwnPropertyDescriptor(NodeProto, 'active');
      editable(NodeProto, 'active', activeDescriptor);
      activeInHierarchyDescriptor = Object.getOwnPropertyDescriptor(NodeProto, 'activeInHierarchy');
      editable(NodeProto, 'activeInHierarchy', activeInHierarchyDescriptor);
      parentDescriptor = Object.getOwnPropertyDescriptor(NodeProto, 'parent');
      editable(NodeProto, 'parent', parentDescriptor);
      serializable(NodeProto, '_parent', function () {
        return null;
      });
      serializable(NodeProto, '_children', function () {
        return [];
      });
      serializable(NodeProto, '_active', function () {
        return true;
      });
      serializable(NodeProto, '_components', function () {
        return [];
      });
      serializable(NodeProto, '_prefab', function () {
        return null;
      });
      serializable(NodeProto, '_lpos', function () {
        return new Vec3();
      });
      serializable(NodeProto, '_lrot', function () {
        return new Quat();
      });
      serializable(NodeProto, '_lscale', function () {
        return new Vec3(1, 1, 1);
      });
      serializable(NodeProto, '_mobility', function () {
        return MobilityMode.Static;
      });
      serializable(NodeProto, '_layer', function () {
        return Layers.Enum.DEFAULT;
      });
      serializable(NodeProto, '_euler', function () {
        return new Vec3();
      });
      eulerAnglesDescriptor = Object.getOwnPropertyDescriptor(NodeProto, 'eulerAngles');
      type(Vec3)(NodeProto, 'eulerAngles', eulerAnglesDescriptor);
      angleDescriptor = Object.getOwnPropertyDescriptor(NodeProto, 'angle');
      editable(NodeProto, 'angle', angleDescriptor);
      mobilityDescriptor = Object.getOwnPropertyDescriptor(NodeProto, 'mobility');
      editable(NodeProto, 'mobility', mobilityDescriptor);
      type(MobilityMode)(NodeProto, 'mobility', mobilityDescriptor);
      layerDescriptor = Object.getOwnPropertyDescriptor(NodeProto, 'layer');
