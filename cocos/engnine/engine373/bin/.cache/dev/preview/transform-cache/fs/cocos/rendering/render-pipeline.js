System.register("q-bundled:///fs/cocos/rendering/render-pipeline.js", ["../core/data/decorators/index.js", "pal/system-info", "./scene-culling.js", "../asset/assets/asset.js", "../gfx/index.js", "../render-scene/scene/camera.js", "./global-descriptor-set-manager.js", "./pipeline-ubo.js", "./render-flow.js", "./pipeline-event.js", "./pipeline-funcs.js", "../../pal/system-info/enum-type/index.js", "../core/index.js", "./define.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RenderPipeline", RenderPipeline = (_dec = ccclass('cc.RenderPipeline'), _dec2 = displayOrder(0), _dec3 = displayOrder(1), _dec4 = type([RenderFlow]), _dec(_class = (_class2 = /*#__PURE__*/function (_Asset) {
        ...
        _proto.onGlobalPipelineStateChanged = function onGlobalPipelineStateChanged() {// do nothing
        };
      ...
      }(Asset), (_initializer = _applyDecoratedInitializer(_class2.prototype, "_tag", [_dec2, serializable], function () {
        return 0;
      }), _initializer2 = _applyDecoratedInitializer(_class2.prototype, "_flows", [_dec3, _dec4, serializable], function () {
        return [];
