System.register("q-bundled:///fs/cocos/serialization/deserialize-dynamic.js", ["../../../virtual/internal%253Aconstants.js", "../core/index.js", "../misc/missing-script.js", "../../pal/system-info/enum-type/index.js", "./ccon.js"], function (_export, _context) {
  ...
  function compileDeserializeJIT(self, klass) {
    ...
    var fastMode = misc.BUILTIN_CLASSID_RE.test(js.getClassId(klass)); // sources.push('var vb,vn,vs,vo,vu,vf;');    // boolean, number, string, object, undefined, function
  ...
  function compileDeserializeNative(_self, klass) {
    var fastMode = misc.BUILTIN_CLASSID_RE.test(js.getClassId(klass));
  ...
  function deserializeDynamic(data, details, options) {
    ...
    var reportMissingClass = (_options$reportMissin = options.reportMissingClass) !== null && _options$reportMissin !== void 0 ? _options$reportMissin : cclegacy.deserialize.reportMissingClass; // var oldJson = JSON.stringify(data, null, 2);
    ...
    execute: function () {
      ...
      _Deserializer = /*#__PURE__*/function () {
        ...
        _proto2._deserializeFastDefinedObject = function _deserializeFastDefinedObject(instance, serialized, klass) {
          ...
          var attrs = CCClass.Attr.getClassAttrs(klass); // @ts-expect-error 2339
