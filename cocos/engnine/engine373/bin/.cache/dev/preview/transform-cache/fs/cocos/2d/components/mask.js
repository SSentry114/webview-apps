System.register("q-bundled:///fs/cocos/2d/components/mask.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../core/index.js", "./graphics.js", "../renderer/stencil-manager.js", "../../scene-graph/node-event-processor.js", "../renderer/render-entity.js", "./sprite.js", "../../scene-graph/index.js"], function (_export, _context) {
  ...
  var ccclass, help, executionOrder, menu, tooltip, displayOrder, type, visible, serializable, range, slide, executeInEditMode, JSB, clamp, Color, Mat4, Vec2, Vec3, warnID, cclegacy, ccenum, Graphics, Stage, NodeEventProcessor, MaskMode, Sprite, NodeEventType, Component, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _class3, _temp, _worldMatrix, _vec2_temp, _mat4_temp, _circlePoints, MaskType, SEGMENTS_MIN, SEGMENTS_MAX, Mask;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Mask", Mask = (_dec = ccclass('cc.Mask'), _dec2 = help('i18n:cc.Mask'), _dec3 = executionOrder(110), _dec4 = menu('2D/Mask'), _dec5 = type(MaskType), _dec6 = tooltip('i18n:mask.type'), _dec7 = displayOrder(14), _dec8 = tooltip('i18n:mask.inverted'), _dec9 = visible(function () {
      ...
      }), _dec11 = range([0, 1, 0.1]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = executeInEditMode(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Component) {
        ...
        _proto._createSprite = function _createSprite() {
          ...
          this._sprite.stencilStage = this.inverted ? Stage.ENTER_LEVEL_INVERTED : Stage.ENTER_LEVEL; // @ts-expect-error Mask hack
        ...
        _proto._disableRender = function _disableRender() {
          if (this.subComp) {
            this.subComp.stencilStage = Stage.DISABLED; // @ts-expect-error Mask hack
        ...
        return Mask;
      }(Component), _class3.Type = MaskType, _temp), (_applyDecoratedDescriptor(_class2.prototype, "type", [_dec5, _dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "type"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "inverted", [_dec7, _dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "inverted"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "segments", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "segments"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "alphaThreshold", [_dec10, _dec11, slide], Object.getOwnPropertyDescriptor(_class2.prototype, "alphaThreshold"), _class2.prototype), _initializer = _applyDecoratedInitializer(_class2.prototype, "_type", [serializable], function () {
