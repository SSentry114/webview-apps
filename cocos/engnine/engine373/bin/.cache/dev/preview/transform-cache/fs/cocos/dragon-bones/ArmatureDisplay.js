System.register("q-bundled:///fs/cocos/dragon-bones/ArmatureDisplay.js", ["../../../virtual/internal%253Aconstants.js", "@cocos/dragonbones-js", "../2d/framework/ui-renderer.js", "../core/index.js", "./ArmatureCache.js", "./AttachUtil.js", "./CCFactory.js", "./DragonBonesAsset.js", "./DragonBonesAtlasAsset.js", "../2d/components/index.js", "../render-scene/core/material-instance.js", "./ArmatureSystem.js", "../2d/renderer/render-entity.js", "../2d/renderer/render-draw-info.js", "../asset/assets/index.js", "../scene-graph/index.js", "../asset/asset-manager/index.js"], function (_export, _context) {
  "use strict";

  var EDITOR, EventObject, UIRenderer, CCClass, Color, Enum, ccenum, errorID, RecyclePool, js, CCObject, EventTarget, cclegacy, _decorator, ArmatureCache, AttachUtil, CCFactory, DragonBonesAsset, DragonBonesAtlasAsset, Graphics, MaterialInstance, ArmatureSystem, RenderEntity, RenderEntityType, RenderDrawInfo, Material, Node, builtinResMgr, _dec, _dec2, _class, _class2, _initializer, _initializer2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _dec28, _dec29, _class4, _class5, _initializer3, _initializer4, _initializer5, _initializer6, _initializer7, _initializer8, _initializer9, _initializer10, _initializer11, _initializer12, _initializer13, _initializer14, _initializer15, _initializer16, _class6, _temp, DefaultArmaturesEnum, DefaultAnimsEnum, DefaultCacheMode, timeScale, AnimationCacheMode, ccclass, serializable, editable, type, help, menu, tooltip, visible, displayName, override, displayOrder, executeInEditMode, DragonBoneSocket, ArmatureDisplay;
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("DragonBoneSocket", DragonBoneSocket = (_dec = ccclass('dragonBones.ArmatureDisplay.DragonBoneSocket'), _dec2 = type(Node), _dec(_class = (_class2 =
      /**
      ...
      _export("ArmatureDisplay", ArmatureDisplay = (_dec3 = ccclass('dragonBones.ArmatureDisplay'), _dec4 = help('i18n:cc.DragonBones'), _dec5 = menu('DragonBones/ArmatureDisplay'), _dec6 = type(DragonBonesAsset), _dec7 = tooltip('i18n:COMPONENT.dragon_bones.dragon_bones_asset'), _dec8 = type(DragonBonesAtlasAsset), _dec9 = tooltip('i18n:COMPONENT.dragon_bones.dragon_bones_atlas_asset'), _dec10 = visible(false), _dec11 = visible(false), _dec12 = displayName('Armature'), _dec13 = type(DefaultArmaturesEnum), _dec14 = tooltip('i18n:COMPONENT.dragon_bones.armature_name'), _dec15 = type(DefaultAnimsEnum), _dec16 = displayName('Animation'), _dec17 = tooltip('i18n:COMPONENT.dragon_bones.animation_name'), _dec18 = displayName('Animation Cache Mode'), _dec19 = tooltip('i18n:COMPONENT.dragon_bones.animation_cache_mode'), _dec20 = tooltip('i18n:COMPONENT.dragon_bones.time_scale'), _dec21 = tooltip('i18n:COMPONENT.dragon_bones.play_times'), _dec22 = tooltip('i18n:COMPONENT.skeleton.premultipliedAlpha'), _dec23 = tooltip('i18n:COMPONENT.dragon_bones.debug_bones'), _dec24 = tooltip('i18n:COMPONENT.dragon_bones.enabled_batch'), _dec25 = type([DragonBoneSocket]), _dec26 = tooltip('i18n:animation.sockets'), _dec27 = type(Material), _dec28 = displayOrder(0), _dec29 = displayName('CustomMaterial'), _dec3(_class4 = _dec4(_class4 = _dec5(_class4 = executeInEditMode(_class4 = (_class5 = (_temp = _class6 = /*#__PURE__*/function (_UIRenderer) {
        ...
        function ArmatureDisplay() {
          ...
          _this = _UIRenderer.call(this) || this; // Property _materialCache Use to cache material,since dragonBones may use multiple texture,
        ...
        _proto.onEnable = function onEnable() {
          _UIRenderer.prototype.onEnable.call(this); // If cache mode is cache, no need to update by dragonbones library.
        ...
        _proto.onDisable = function onDisable() {
          _UIRenderer.prototype.onDisable.call(this); // If cache mode is cache, no need to update by dragonbones library.
        ...
        _proto.updateAnimation = function updateAnimation(dt) {
          ...
          if (!this._playing) {
            if (frameCache.isInvalid()) {
              ...
              this._curFrame = frames[frames.length - 1]; // Update render data size if needed
