  ...
  return {
    ...
    execute: function () {
      ...
      _export("Toggle", Toggle = (_dec = ccclass('cc.Toggle'), _dec2 = help('i18n:cc.Toggle'), _dec3 = executionOrder(110), _dec4 = menu('UI/Toggle'), _dec5 = requireComponent(UITransform), _dec6 = displayOrder(1), _dec7 = tooltip('i18n:toggle.isChecked'), _dec8 = type(Sprite), _dec9 = displayOrder(1), _dec10 = tooltip('i18n:toggle.checkMark'), _dec11 = type([ComponentEventHandler]), _dec12 = tooltip('i18n:toggle.check_events'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Button) {
        ...
        return Toggle;
      }(Button), _class3.EventType = extendsEnum(EventType, ButtonEventType), _temp), (_applyDecoratedDescriptor(_class2.prototype, "isChecked", [_dec6, _dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "isChecked"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "checkMark", [_dec8, _dec9, _dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "checkMark"), _class2.prototype), _initializer = _applyDecoratedInitializer(_class2.prototype, "checkEvents", [_dec11, serializable, _dec12], function () {
        return [];
