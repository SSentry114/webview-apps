System.register("q-bundled:///fs/cocos/core/data/object.js", ["../../../../virtual/internal%253Aconstants.js", "../utils/js.js", "./class.js", "../platform/debug.js", "../global-exports.js", "./editor-extras-tag.js"], function (_export, _context) {
  ...
  var SUPPORT_JIT, EDITOR, TEST, JSB, js, CCClass, errorID, warnID, legacyCC, editorExtrasTag, copyAllProperties, _CCClass$fastDefine, Destroyed, RealDestroyed, ToDestroy, DontSave, EditorOnly, Dirty, DontDestroy, Destroying, Deactivating, LockedInEditor, HideInHierarchy, IsOnEnableCalled, IsEditorOnEnableCalled, IsPreloadStarted, IsOnLoadCalled, IsOnLoadStarted, IsStartCalled, IsRotationLocked, IsScaleLocked, IsAnchorLocked, IsSizeLocked, IsPositionLocked, IsReplicated, IsClientLoad, PersistentMask, AllHideMasks, objectsToDestroy, deferredDestroyTimer, CCObject, prototype;
  ...
  return {
    ...
    execute: function () {
      ...
      if (JSB) {
        ...
        copyAllProperties(CCObject.prototype, jsb.CCObject.prototype, ['constructor', 'name', 'hideFlags', 'replicated', 'isValid']); // @ts-expect-error TS2629
