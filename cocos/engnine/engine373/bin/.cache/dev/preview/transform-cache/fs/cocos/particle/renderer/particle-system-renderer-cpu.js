System.register("q-bundled:///fs/cocos/particle/renderer/particle-system-renderer-cpu.js", ["../../../../virtual/internal%253Aconstants.js", "../../asset/asset-manager/index.js", "../../gfx/index.js", "../../core/index.js", "../../render-scene/core/material-instance.js", "../enum.js", "../particle.js", "./particle-system-renderer-base.js", "../noise.js", "../particle-general-function.js"], function (_export, _context) {
  ...
  var EDITOR, builtinResMgr, AttributeName, Format, Attribute, FormatInfos, Mat4, Vec2, Vec3, Vec4, pseudoRandom, Quat, EPSILON, approx, RecyclePool, cclegacy, MaterialInstance, AlignmentSpace, RenderMode, Space, Particle, PARTICLE_MODULE_ORDER, PARTICLE_MODULE_NAME, ParticleSystemRendererBase, ParticleNoise, isCurveTwoValues, _tempAttribUV, _tempWorldTrans, _tempParentInverse, _node_rot, _node_euler, _anim_module, _uvs, CC_USE_WORLD_SPACE, CC_RENDER_MODE, ROTATION_OVER_TIME_MODULE_ENABLE, INSTANCE_PARTICLE, RENDER_MODE_BILLBOARD, RENDER_MODE_STRETCHED_BILLBOARD, RENDER_MODE_HORIZONTAL_BILLBOARD, RENDER_MODE_VERTICAL_BILLBOARD, RENDER_MODE_MESH, _vertex_attrs, _vertex_attrs_stretch, _vertex_attrs_mesh, _vertex_attrs_ins, _vertex_attrs_stretch_ins, _vertex_attrs_mesh_ins, _matInsInfo, ParticleSystemRendererCPU;
          ...
          if (this._alignSpace === AlignmentSpace.Local) {
            ...
            if (cameraLst !== undefined) {
              for (var i = 0; i < (cameraLst === null || cameraLst === void 0 ? void 0 : cameraLst.length); ++i) {
                ...
                var checkCamera = !EDITOR || cclegacy.GAME_VIEW ? (camera.visibility & this._particleSystem.node.layer) === this._particleSystem.node.layer : camera.name === 'Editor Camera';
