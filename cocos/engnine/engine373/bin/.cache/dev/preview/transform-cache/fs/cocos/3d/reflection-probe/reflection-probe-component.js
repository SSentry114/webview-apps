  ...
  return {
    ...
    execute: function () {
      ...
      _export("ReflectionProbe", ReflectionProbe = (_dec = ccclass('cc.ReflectionProbe'), _dec2 = menu('Rendering/ReflectionProbe'), _dec3 = type(Vec3), _dec4 = type(Enum(ProbeType)), _dec5 = visible(function () {
        ...
        return this.probeType === ProbeType.CUBE;
      }), _dec15 = type(CCBoolean), _dec16 = tooltip('i18n:reflection_probe.fastBake'), _dec(_class = _dec2(_class = executeInEditMode(_class = playOnFocus(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Component) {
      ...
      }(Component), _class3.DEFAULT_CUBE_SIZE = new Vec3(1, 1, 1), _class3.DEFAULT_PLANER_SIZE = new Vec3(5, 0.5, 5), _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "_resolution", [serializable], function () {
        return 256;
