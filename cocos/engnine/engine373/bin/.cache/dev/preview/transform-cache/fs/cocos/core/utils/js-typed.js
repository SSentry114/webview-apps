System.register("q-bundled:///fs/cocos/core/utils/js-typed.js", ["../../../../virtual/internal%253Aconstants.js", "../platform/debug.js", "./id-generator.js"], function (_export, _context) {
  ...
  function getClassName(objOrCtor) {
    if (typeof objOrCtor === 'function') {
      var prototype = objOrCtor.prototype; // eslint-disable-next-line no-prototype-builtins

      if (prototype && prototype.hasOwnProperty(classNameTag) && prototype[classNameTag]) {
        return prototype[classNameTag];
      }

      var ret = ''; //  for browsers which have name property in the constructor of the object, such as chrome
  ...
  function getSuper(constructor) {
    ...
    var dunderProto = proto && Object.getPrototypeOf(proto); // eslint-disable-next-line @typescript-eslint/no-unsafe-return
...
js.unregisterClass to remove the id of unused class';
  ...
  function getClassId(obj, allowTempId) {
    ...
    var res; // eslint-disable-next-line no-prototype-builtins
    ...
    if (obj && obj.constructor) {
      var prototype = obj.constructor.prototype; // eslint-disable-next-line no-prototype-builtins
