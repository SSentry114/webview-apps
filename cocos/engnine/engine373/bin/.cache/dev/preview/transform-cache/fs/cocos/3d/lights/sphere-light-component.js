System.register("q-bundled:///fs/cocos/3d/lights/sphere-light-component.js", ["../../core/data/decorators/index.js", "../../render-scene/index.js", "./light-component.js", "../../core/index.js", "../../render-scene/scene/index.js"], function (_export, _context) {
  ...
  var ccclass, help, executeInEditMode, menu, tooltip, type, displayOrder, serializable, formerlySerializedAs, scene, Light, PhotometricTerm, cclegacy, Camera, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _initializer5, SphereLight;
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("SphereLight", SphereLight = (_dec = ccclass('cc.SphereLight'), _dec2 = help('i18n:cc.SphereLight'), _dec3 = menu('Light/SphereLight'), _dec4 = formerlySerializedAs('_luminance'), _dec5 = displayOrder(-1), _dec6 = tooltip('i18n:lights.luminous_flux'), _dec7 = displayOrder(-1), _dec8 = tooltip('i18n:lights.luminance'), _dec9 = type(PhotometricTerm), _dec10 = displayOrder(-2), _dec11 = tooltip('i18n:lights.term'), _dec12 = tooltip('i18n:lights.size'), _dec13 = tooltip('i18n:lights.range'), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = /*#__PURE__*/function (_Light) {
        ...
        return 1;
      }), _applyDecoratedDescriptor(_class2.prototype, "luminousFlux", [_dec5, _dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "luminousFlux"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "luminance", [_dec7, _dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "luminance"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "term", [_dec9, _dec10, _dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "term"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "size", [_dec12], Object.getOwnPropertyDescriptor(_class2.prototype, "size"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "range", [_dec13], Object.getOwnPropertyDescriptor(_class2.prototype, "range"), _class2.prototype)), _class2)) || _class) || _class) || _class) || _class));
    }
  };
});