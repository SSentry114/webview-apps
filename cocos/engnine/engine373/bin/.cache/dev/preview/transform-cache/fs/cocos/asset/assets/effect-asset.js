  ...
  return {
    ...
    execute: function () {
      ...
      _export("EffectAsset", EffectAsset = (_dec = ccclass('cc.EffectAsset'), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Asset) {
        ...
        return EffectAsset;
      }(Asset), _class3._effects = {}, _class3._layoutValid = true, _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "techniques", [serializable, editable], function () {
        return [];
