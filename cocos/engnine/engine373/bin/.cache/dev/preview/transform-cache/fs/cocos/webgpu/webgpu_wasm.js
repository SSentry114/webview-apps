System.register("q-bundled:///fs/cocos/webgpu/webgpu_wasm.js", [], function (_export, _context) {
  "use strict";
    ...
    execute: function () {
      wasmDevice = function () {
        ...
        return function (wasmDevice) {
          ...
          var WebGPU = {
            initManagers: function initManagers() {
            ...
            makeColor: function makeColor(ptr) {
              return {
                "r": HEAPF64[ptr >> 3],
                "g": HEAPF64[ptr + 8 >> 3],
                "b": HEAPF64[ptr + 16 >> 3],
            ...
            makeExtent3D: function makeExtent3D(ptr) {
              return {
                "width": HEAPU32[ptr >> 2],
            ...
            makeOrigin3D: function makeOrigin3D(ptr) {
              return {
                "x": HEAPU32[ptr >> 2],
                "y": HEAPU32[ptr + 4 >> 2],
                "z": HEAPU32[ptr + 8 >> 2]
            ...
            makeImageCopyTexture: function makeImageCopyTexture(ptr) {
              return {
            ...
            makeTextureDataLayout: function makeTextureDataLayout(ptr) {
            ...
            makeImageCopyBuffer: function makeImageCopyBuffer(ptr) {
              var layoutPtr = ptr + 8;
              var bufferCopyView = WebGPU.makeTextureDataLayout(layoutPtr);
              bufferCopyView["buffer"] = WebGPU.mgrBuffer.get(HEAPU32[ptr + 32 >> 2]);
              return bufferCopyView;
            },
            makePipelineConstants: function makePipelineConstants(constantCount, constantsPtr) {
            ...
            makeProgrammableStageDescriptor: function makeProgrammableStageDescriptor(ptr) {
          ...
          var asmLibraryArg = {
            ...
            "k": __emval_as,
            "da": __emval_call_void_method,
            "b": __emval_decref,
            "ea": __emval_get_method_caller,
            ...
            "Ga": _emscripten_webgpu_get_device,
            "ra": _environ_get,
            "sa": _environ_sizes_get,
            "ta": _fd_write,
            "Y": _setTempRet0,
            "La": _wgpuAdapterGetProperties,
            "S": _wgpuAdapterHasFeature,
            "Ia": _wgpuAdapterRelease,
            "U": _wgpuBindGroupRelease,
            "la": _wgpuBufferDestroy,
            "G": _wgpuBufferGetMappedRange,
            "R": _wgpuBufferRelease,
            "F": _wgpuBufferUnmap,
            "E": _wgpuCommandBufferRelease,
            "Na": _wgpuCommandEncoderBeginComputePass,
            "M": _wgpuCommandEncoderBeginRenderPass,
            "Xa": _wgpuCommandEncoderCopyBufferToBuffer,
            "ma": _wgpuCommandEncoderCopyBufferToTexture,
            "Oa": _wgpuCommandEncoderCopyTextureToTexture,
            "v": _wgpuCommandEncoderFinish,
            "x": _wgpuCommandEncoderRelease,
            "Ma": _wgpuComputePassEncoderDispatchWorkgroups,
            "Wa": _wgpuComputePassEncoderDispatchWorkgroupsIndirect,
            "Da": _wgpuComputePassEncoderEnd,
            "Ca": _wgpuComputePassEncoderRelease,
            "Ta": _wgpuComputePassEncoderSetBindGroup,
            "Sa": _wgpuComputePassEncoderSetPipeline,
            "aa": _wgpuComputePipelineRelease,
            "D": _wgpuDeviceCreateBindGroup,
            "C": _wgpuDeviceCreateBindGroupLayout,
            "B": _wgpuDeviceCreateBuffer,
            "y": _wgpuDeviceCreateCommandEncoder,
            "Ba": _wgpuDeviceCreateComputePipeline,
            "P": _wgpuDeviceCreatePipelineLayout,
            "O": _wgpuDeviceCreateRenderPipeline,
            "$": _wgpuDeviceCreateSampler,
            "u": _wgpuDeviceCreateShaderModule,
            "ya": _wgpuDeviceCreateSwapChain,
            "K": _wgpuDeviceCreateTexture,
            "ga": _wgpuDeviceGetQueue,
            "Ha": _wgpuDeviceRelease,
            "Fa": _wgpuInstanceCreateSurface,
            "Ja": _wgpuInstanceRelease,
            "Ea": _wgpuInstanceRequestAdapter,
            "ca": _wgpuPipelineLayoutRelease,
            "ia": _wgpuQuerySetDestroy,
            "ha": _wgpuQuerySetRelease,
            "Va": _wgpuQueueOnSubmittedWorkDone,
            "Q": _wgpuQueueRelease,
            "z": _wgpuQueueSubmit,
            "qa": _wgpuQueueWriteBuffer,
            "fa": _wgpuQueueWriteTexture,
            "V": _wgpuRenderPassEncoderDraw,
            "Pa": _wgpuRenderPassEncoderDrawIndexed,
            "Za": _wgpuRenderPassEncoderDrawIndexedIndirect,
            "Ya": _wgpuRenderPassEncoderDrawIndirect,
            "I": _wgpuRenderPassEncoderEnd,
            "X": _wgpuRenderPassEncoderRelease,
            "A": _wgpuRenderPassEncoderSetBindGroup,
            "Ra": _wgpuRenderPassEncoderSetBlendConstant,
            "_a": _wgpuRenderPassEncoderSetIndexBuffer,
            "W": _wgpuRenderPassEncoderSetPipeline,
            "na": _wgpuRenderPassEncoderSetScissorRect,
            "Qa": _wgpuRenderPassEncoderSetStencilReference,
            "pa": _wgpuRenderPassEncoderSetVertexBuffer,
            "oa": _wgpuRenderPassEncoderSetViewport,
            "ba": _wgpuRenderPipelineRelease,
            "Aa": _wgpuSamplerRelease,
            "N": _wgpuShaderModuleRelease,
            "Ka": _wgpuSurfaceRelease,
            "L": _wgpuSwapChainGetCurrentTextureView,
            "za": _wgpuSwapChainRelease,
          ...
          var ___embind_register_native_and_builtin_types = Module["___embind_register_native_and_builtin_types"] = function () {
            return (___embind_register_native_and_builtin_types = Module["___embind_register_native_and_builtin_types"] = Module["asm"]["fb"]).apply(null, arguments);
          };

          var dynCall_jii = Module["dynCall_jii"] = function () {
            return (dynCall_jii = Module["dynCall_jii"] = Module["asm"]["gb"]).apply(null, arguments);
          };

          var dynCall_viij = Module["dynCall_viij"] = function () {
            return (dynCall_viij = Module["dynCall_viij"] = Module["asm"]["hb"]).apply(null, arguments);
          };
