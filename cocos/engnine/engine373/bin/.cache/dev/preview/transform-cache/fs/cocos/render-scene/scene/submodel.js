    ...
    execute: function () {
      ...
      _export("SubModel", SubModel = /*#__PURE__*/function () {
        ...
        _proto.initialize = function initialize(subMesh, passes, patches) {
          ...
          var r = cclegacy.rendering; // initialize resources for reflection material
        ...
        _proto.onGeometryChanged = function onGeometryChanged() {
          ...
          var drawInfo = this._subMesh.drawInfo; // to invoke getter/setter function for wasm object
