System.register("q-bundled:///fs/pal/minigame/taobao_minigame.js", ["../screen-adapter/enum-type/index.js", "../utils.js", "../system-info/enum-type/index.js"], function (_export, _context) {
  "use strict";
  ...
  function adapterGL(gl) {
    ...
    if (!my.isIDE) {
      ...
      if (my.getSystemInfoSync().platform.toLocaleLowerCase() === 'ios') {
        var originalGetUniformLocation = gl.getUniformLocation.bind(gl); // eslint-disable-next-line func-names
  ...
  return {
    ...
    execute: function () {
      ...
      minigame.createInnerAudioContext = function () {
        var audio = polyfilledCreateInnerAudio(); // @ts-expect-error InnerAudioContext has onCanPlay
