System.register("q-bundled:///fs/cocos/animation/tracks/track.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../core/index.js", "../../scene-graph/index.js", "../define.js", "../target-path.js"], function (_export, _context) {
  "use strict";

  var ccclass, serializable, uniquelyReferenced, SUPPORT_JIT, assertIsTrue, errorID, warnID, js, Node, CLASS_NAME_PREFIX_ANIM, createEvalSymbol, ComponentPath, HierarchyPath, isPropertyPath, _dec, _class, _class2, _initializer, _dec2, _class4, _class5, _initializer2, _initializer3, _class6, _temp, _dec3, _class7, _class8, _initializer4, _dec4, _class10, _class11, _initializer5, _dec5, _class13, _class14, _initializer6, normalizedFollowTag, parseTrsPathTag, trackBindingTag, TrackPath, TrackBinding, Track, Channel, SingleChannelTrack, SingleChannelTrackEval;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TrackBinding", TrackBinding = (_dec2 = ccclass(CLASS_NAME_PREFIX_ANIM + "TrackBinding"), _dec2(_class4 = uniquelyReferenced(_class4 = (_class5 = (_temp = _class6 = /*#__PURE__*/function () {
        ...
        return TrackBinding;
      }(), _class6._animationFunctions = new WeakMap(), _temp), (_initializer2 = _applyDecoratedInitializer(_class5.prototype, "path", [serializable], function () {
