System.register("q-bundled:///fs/cocos/core/data/class.js", ["../../../../virtual/internal%253Aconstants.js", "../platform/debug.js", "../utils/js.js", "../value-types/index.js", "../value-types/enum.js", "./utils/attribute.js", "./utils/preprocess-class.js", "./utils/requiring-frame.js", "../global-exports.js", "./class-stash.js"], function (_export, _context) {
  "use strict";

  var DEV, EDITOR, SUPPORT_JIT, TEST, errorID, warnID, error, js, getSuper, BitMask, Enum, attributeUtils, preprocessAttrs, RF, legacyCC, PropertyStashInternalFlag, DELIMETER, CCCLASS_TAG, ENUM_TAG, BITMASK_TAG, IDENTIFIER_RE, PrimitiveTypes, onAfterProps_ET;
  ...
  function parseAttributes(constructor, attributes, className, propertyName, usedInGetter) {
    ...
    } else if ((EDITOR && !window.Build || TEST) && warnOnNoDefault && !(attributes.get || attributes.set)) {// TODO: we close this warning for now:
