System.register("q-bundled:///fs/cocos/sorting/sorting.js", ["../core/data/decorators/index.js", "../core/math/index.js", "./sorting-layers.js", "../scene-graph/component.js", "../core/platform/debug.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Sorting", Sorting = (_dec = ccclass('cc.Sorting'), _dec2 = menu('Sorting/Sorting'), _dec3 = type(SortingLayers.Enum), _dec4 = range([MIN_INT16, MAX_INT16, 1]), _dec(_class = _dec2(_class = disallowMultiple(_class = executeInEditMode(_class = (_class2 = /*#__PURE__*/function (_Component) {
