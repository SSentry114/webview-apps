      ...
      _export("ImageAsset", ImageAsset = (_dec = ccclass('cc.ImageAsset'), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Asset) {
        ...
        ImageAsset.mergeCompressedTextureMips = function mergeCompressedTextureMips(files) {
          ...
          try {
            ...
            var outView = new DataView(out.buffer, out.byteOffset, out.byteLength); // Append compresssed header
        ...
        ImageAsset.parseCompressedTextures = function parseCompressedTextures(file, type) {
          ...
          var bufferView = new DataView(buffer); // Get a view of the arrayBuffer that represents compress header.

          var magicNumber = bufferView.getUint32(0, true); // Do some sanity checks to make sure this is a valid compress file.
          ...
          if (magicNumber === COMPRESSED_MIPMAP_MAGIC) {
            ...
            var fileHeaderByteLength = COMPRESSED_HEADER_LENGTH + COMPRESSED_MIPMAP_LEVEL_COUNT_LENGTH + mipmapLevelNumber * COMPRESSED_MIPMAP_DATA_SIZE_LENGTH; // Get a view of the arrayBuffer that represents compress chunks.
        ...
        ImageAsset.parsePVRTexture = function parsePVRTexture(file, levelIndex, beginOffset, endOffset, out) {
          ...
          var header = new Int32Array(buffer, beginOffset, PVR_HEADER_LENGTH); // Do some sanity checks to make sure this is a valid DDS file.
        ...
        _proto._serialize = function _serialize() {
          if (EDITOR || TEST) {
            ...
            for (var _iterator2 = _createForOfIteratorHelperLoose(targetExtensions), _step2; !(_step2 = _iterator2()).done;) {
              var targetExtension = _step2.value;
