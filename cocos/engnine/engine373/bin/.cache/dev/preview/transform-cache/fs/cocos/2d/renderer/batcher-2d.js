    ...
    execute: function () {
      ...
      _export("Batcher2D", Batcher2D = /*#__PURE__*/function () {
        ...
        _proto.switchBufferAccessor = function switchBufferAccessor(attributes) {
          ...
          var strideBytes = attributes === vfmtPosUvColor ? 36
          /* 9x4 */
        ...
        _proto.updateBuffer = function updateBuffer(attributes, bid) {
          var accessor = this.switchBufferAccessor(attributes); // If accessor changed, then current bid will be reset to -1, this check will pass too
        ...
        _proto.autoMergeBatches = function autoMergeBatches(renderComp) {
          ...
          var accessor = this._staticVBBuffer; // Previous batch using mesh buffer
