System.register("q-bundled:///fs/cocos/physics-2d/box2d/physics-world.js", ["@cocos/box2d", "../../../../virtual/internal%253Aconstants.js", "../../core/index.js", "../framework/physics-types.js", "../../2d/framework/index.js", "../../2d/components/index.js", "./platform/physics-contact-listener.js", "./platform/physics-aabb-query-callback.js", "./platform/physics-ray-cast-callback.js", "./platform/physics-debug-draw.js", "../../scene-graph/index.js", "../../game/index.js"], function (_export, _context) {
  ...
  var b2, EDITOR, Vec3, Quat, toRadian, Vec2, toDegree, CCObject, js, cclegacy, PHYSICS_2D_PTM_RATIO, ERaycast2DType, ERigidBody2DType, Canvas, Graphics, PhysicsContactListener, PhysicsAABBQueryCallback, PhysicsRayCastCallback, PhysicsDebugDraw, Node, find, Layers, director, tempVec3, tempVec2_1, tempVec2_2, temoBodyDef, tempB2AABB, testResults, b2PhysicsWorld;
    ...
    execute: function () {
      ...
      _export("b2PhysicsWorld", b2PhysicsWorld = /*#__PURE__*/function () {
        function b2PhysicsWorld() {
          ...
          var tempBodyDef = new b2.BodyDef(); //tempBodyDef.position.Set(480 / PHYSICS_2D_PTM_RATIO, 320 / PHYSICS_2D_PTM_RATIO);//temporary
