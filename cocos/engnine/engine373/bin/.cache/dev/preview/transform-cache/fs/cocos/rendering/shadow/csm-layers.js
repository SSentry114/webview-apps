System.register("q-bundled:///fs/cocos/rendering/shadow/csm-layers.js", ["../../render-scene/scene/index.js", "../../core/math/index.js", "../../core/geometry/index.js", "../../core/memop/cached-array.js", "../../core/index.js"], function (_export, _context) {
  "use strict";
    ...
    execute: function () {
      ...
      _export("ShadowLayerVolume", ShadowLayerVolume = /*#__PURE__*/function () {
        ...
        _proto.createMatrix = function createMatrix(dirLight, shadowMapWidth, onlyForCulling) {
          ...
          Frustum.copy(this._lightViewFrustum, this._splitFrustum); // view matrix with range back
          ...
          this._lightViewFrustum.transform(_matShadowView); // bounding box in light space
          ...
          if (!onlyForCulling) {
            ...
            Mat4.invert(_matShadowView, _matShadowTrans); // fill data
      ...
      _export("CSMLayers", CSMLayers = /*#__PURE__*/function () {
        ...
        _proto3._splitFrustumLevels = function _splitFrustumLevels(dirLight) {
          ...
          for (var i = 1; i < level; i++) {
            // i ÷ numbers of level
            var si = i / level; // eslint-disable-next-line no-restricted-properties

            var preNear = lambda * (nd * Math.pow(ratio, si)) + (1 - lambda) * (nd + (fd - nd) * si); // Slightly increase the overlap to avoid fracture
        ...
        _createClass(CSMLayers, [{
          ...
          get: // LevelCount is a scalar, Indicates the number.
