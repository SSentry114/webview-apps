  ...
  return {
    ...
    execute: function () {
      ...
      imageAssetProto._deserialize = function (data) {
        ...
        var preferedExtensionIndex = Number.MAX_VALUE; // let format = this._format;
        ...
        for (var _iterator2 = _createForOfIteratorHelperLoose(extensionIDs), _step2; !(_step2 = _iterator2()).done;) {
          ...
          var i = parseInt(extFormat[0], undefined); // const tmpExt = ImageAsset.extnames[i] || extFormat[0];
          ...
          if (index !== -1 && index < preferedExtensionIndex) {
            ...
            var fmt = extFormat[1] ? parseInt(extFormat[1]) : this.format; // check whether or not support compressed texture
