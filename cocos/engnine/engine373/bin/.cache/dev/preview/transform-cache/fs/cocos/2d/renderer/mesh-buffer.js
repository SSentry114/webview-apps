      ...
      _export("MeshBuffer", MeshBuffer = /*#__PURE__*/function () {
        ...
        _proto.uploadBuffers = function uploadBuffers() {
          ...
          if (iOS14 && submitCount / this._iaPool.length < IA_POOL_USED_SCALE) {
            ...
            var length = this._iaPool.length; // Destroy InputAssemblers
        ...
        _proto.createNewIA = function createNewIA(device) {
          var ia;
          var vertexBuffers;
          var indexBuffer; // HACK: After sharing buffer between drawcalls, the performance degradation a lots on iOS 14 or iPad OS 14 device
