System.register("q-bundled:///fs/cocos/root.js", ["./core/index.js", "./rendering/index.js", "./rendering/debug-view.js", "./render-scene/scene/index.js", "./render-scene/scene/light.js", "./render-scene/core/render-scene.js", "./render-scene/core/render-window.js", "./gfx/index.js", "./rendering/define.js", "./xr/xr-enums.js"], function (_export, _context) {
  "use strict";

  var Pool, cclegacy, warnID, settings, Settings, macro, createDefaultPipeline, DeferredPipeline, DebugView, Camera, CameraType, TrackingType, LightType, RenderScene, RenderWindow, ColorAttachment, DepthStencilAttachment, RenderPassInfo, StoreOp, Feature, deviceManager, LegacyRenderMode, localDescriptorSetLayout_ResizeMaxJoints, UBOCamera, UBOGlobal, UBOLocal, UBOShadow, UBOWorldBound, XREye, XRPoseType, Root;
  ...
  return {
    setters: [function (_coreIndexJs) {
      ...
      createDefaultPipeline = _renderingIndexJs.createDefaultPipeline;
      DeferredPipeline = _renderingIndexJs.DeferredPipeline;
    ...
    execute: function () {
      ...
      _export("Root", Root = /*#__PURE__*/function () {
        ...
        _proto._resizeMaxJointForDS = function _resizeMaxJointForDS() {
          var usedUBOVectorCount = (UBOGlobal.COUNT + UBOCamera.COUNT + UBOShadow.COUNT + UBOLocal.COUNT + UBOWorldBound.COUNT) / 4;
