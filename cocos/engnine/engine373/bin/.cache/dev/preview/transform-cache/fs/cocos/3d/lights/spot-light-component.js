System.register("q-bundled:///fs/cocos/3d/lights/spot-light-component.js", ["../../core/index.js", "../../render-scene/index.js", "./light-component.js", "../../render-scene/scene/index.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("SpotLight", SpotLight = (_dec = ccclass('cc.SpotLight'), _dec2 = help('i18n:cc.SpotLight'), _dec3 = menu('Light/SpotLight'), _dec4 = formerlySerializedAs('_luminance'), _dec5 = tooltip('i18n:lights.luminous_flux'), _dec6 = displayOrder(-1), _dec7 = tooltip('i18n:lights.luminance'), _dec8 = displayOrder(-1), _dec9 = type(PhotometricTerm), _dec10 = displayOrder(-2), _dec11 = tooltip('i18n:lights.term'), _dec12 = tooltip('i18n:lights.size'), _dec13 = tooltip('i18n:lights.range'), _dec14 = range([2, 180, 1]), _dec15 = tooltip('The spot light cone angle'), _dec16 = tooltip('i18n:lights.shadowEnabled'), _dec17 = visible(function () {
      ...
      }), _dec19 = type(CCBoolean), _dec20 = tooltip('i18n:lights.shadowPcf'), _dec21 = visible(function () {
        return cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap;
      }), _dec22 = property({
        group: {
          name: 'DynamicShadowSettings',
      ...
      }), _dec23 = type(PCFType), _dec24 = tooltip('i18n:lights.shadowBias'), _dec25 = visible(function () {
        return cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap;
      }), _dec26 = property({
        group: {
          name: 'DynamicShadowSettings',
      ...
      }), _dec27 = type(CCFloat), _dec28 = tooltip('i18n:lights.shadowNormalBias'), _dec29 = visible(function () {
        return cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap;
      }), _dec30 = property({
        group: {
          name: 'DynamicShadowSettings',
      ...
      }), _dec31 = type(CCFloat), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = /*#__PURE__*/function (_Light) {
        ...
        function SpotLight() {
          ...
          _this._shadowEnabled = _initializer7 && _initializer7();
          _this._shadowPcf = _initializer8 && _initializer8();
          _this._shadowBias = _initializer9 && _initializer9();
          _this._shadowNormalBias = _initializer10 && _initializer10();
