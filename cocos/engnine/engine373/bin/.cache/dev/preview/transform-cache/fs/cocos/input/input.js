    ...
    execute: function () {
      ...
      _export("Input", Input = /*#__PURE__*/function () {
        ...
        _proto2._frameDispatchEvents = function _frameDispatchEvents() {
          var eventHMDList = this._eventHMDList; // TODO: culling event queue
          ...
          var eventHandheldList = this._eventHandheldList; // TODO: culling event queue
          ...
          var eventGamepadList = this._eventGamepadList; // TODO: culling event queue
          ...
          var eventHandleList = this._eventHandleList; // TODO: culling event queue
