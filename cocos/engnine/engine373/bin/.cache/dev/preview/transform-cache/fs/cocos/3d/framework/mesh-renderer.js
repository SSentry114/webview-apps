  ...
  return {
    ...
    execute: function () {
      ...
      ModelBakeSettings = (_dec = ccclass('cc.ModelBakeSettings'), _dec2 = formerlySerializedAs('_recieveShadow'), _dec3 = group({
        ...
        id: 'ReflectionProbe',
        name: 'ReflectionProbeSettings'
      }), _dec16 = type(CCBoolean), _dec(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_EventTarget) {
        ...
        function ModelBakeSettings() {
          ...
          _this._probeCubemap = _initializer11 && _initializer11();
      ...
      }(EventTarget), _class3.USE_LIGHT_PROBE_CHANGED = 'use_light_probe_changed', _class3.REFLECTION_PROBE_CHANGED = 'reflection_probe_changed', _class3.BAKE_TO_REFLECTION_PROBE_CHANGED = 'bake_to_reflection_probe_changed', _temp), (_initializer = _applyDecoratedInitializer(_class2.prototype, "texture", [serializable], function () {
        return null;
      ...
      _export("MeshRenderer", MeshRenderer = (_dec17 = ccclass('cc.MeshRenderer'), _dec18 = help('i18n:cc.MeshRenderer'), _dec19 = executionOrder(100), _dec20 = menu('Mesh/MeshRenderer'), _dec21 = displayOrder(3), _dec22 = type(CCFloat), _dec23 = tooltip('i18n:model.shadow_bias'), _dec24 = group({
      ...
      }), _dec17(_class4 = _dec18(_class4 = _dec19(_class4 = _dec20(_class4 = executeInEditMode(_class4 = (_class5 = (_temp2 = _class6 = /*#__PURE__*/function (_ModelRenderer) {
        ...
        function MeshRenderer() {
          ...
          _this2.bakeSettings = _initializer12 && _initializer12();
          _this2._mesh = _initializer13 && _initializer13();
          _this2._shadowCastingMode = _initializer14 && _initializer14();
          _this2._shadowReceivingMode = _initializer15 && _initializer15();
          _this2._shadowBias = _initializer16 && _initializer16();
          _this2._shadowNormalBias = _initializer17 && _initializer17();
          _this2._reflectionProbeId = _initializer18 && _initializer18();
        ...
        return MeshRenderer;
      }(ModelRenderer), _class6.ShadowCastingMode = ModelShadowCastingMode, _class6.ShadowReceivingMode = ModelShadowReceivingMode, _temp2), (_initializer12 = _applyDecoratedInitializer(_class5.prototype, "bakeSettings", [serializable, editable, disallowAnimation, _dec21], function () {
