System.register("q-bundled:///fs/cocos/scene-graph/scene-globals.js", ["../core/data/decorators/index.js", "../../../virtual/internal%253Aconstants.js", "../asset/assets/texture-cube.js", "../core/data/utils/attribute.js", "../core/math/index.js", "../render-scene/scene/ambient.js", "../render-scene/scene/shadows.js", "../render-scene/scene/skybox.js", "../render-scene/scene/fog.js", "../core/global-exports.js", "../core/platform/debug.js", "../asset/assets/material.js", "../core/index.js", "./node-event.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      }), _dec3 = tooltip('i18n:ambient.skyLightingColor'), _dec4 = type(CCFloat), _dec5 = tooltip('i18n:ambient.skyIllum'), _dec6 = visible(function () {
        var scene = legacyCC.director.getScene();
        var skybox = scene.globals.skybox;
      ...
      }), _dec7 = tooltip('i18n:ambient.groundLightingColor'), _dec8 = formerlySerializedAs('_skyColor'), _dec9 = formerlySerializedAs('_skyIllum'), _dec10 = formerlySerializedAs('_groundAlbedo'), _dec(_class = (_class2 = /*#__PURE__*/function () {
      ...
      _export("FogInfo", FogInfo = (_dec37 = ccclass('cc.FogInfo'), _dec38 = tooltip('i18n:fog.enabled'), _dec39 = displayOrder(0), _dec40 = tooltip('i18n:fog.accurate'), _dec41 = displayOrder(0), _dec42 = tooltip('i18n:fog.fogColor'), _dec43 = type(FogType), _dec44 = displayOrder(1), _dec45 = tooltip('i18n:fog.type'), _dec46 = visible(function () {
        ...
        return this._type === FogType.LAYERED;
      }), _dec68 = type(CCFloat), _dec69 = rangeStep(0.01), _dec70 = tooltip('i18n:fog.fogRange'), _dec37(_class7 = (_class8 = (_temp = _class9 = /*#__PURE__*/function () {
        function FogInfo() {
      ...
      _export("ShadowsInfo", ShadowsInfo = (_dec71 = ccclass('cc.ShadowsInfo'), _dec72 = tooltip('i18n:shadow.enabled'), _dec73 = tooltip('i18n:shadow.type'), _dec74 = type(ShadowType), _dec75 = tooltip('i18n:shadow.shadowColor'), _dec76 = visible(function () {
        ...
        return this._type === ShadowType.ShadowMap;
      }), _dec71(_class10 = (_class11 = /*#__PURE__*/function () {
       ...
       * @zh 光照探针配置
       */
      _export("LightProbeInfo", LightProbeInfo = (_dec97 = ccclass('cc.LightProbeInfo'), _dec98 = range([0, 100, 1]), _dec99 = type(CCFloat), _dec100 = tooltip('i18n:light_probe.giScale'), _dec101 = displayName('GIScale'), _dec102 = range([64, 65535, 1]), _dec103 = type(CCInteger), _dec104 = tooltip('i18n:light_probe.giSamples'), _dec105 = displayName('GISamples'), _dec106 = range([1, 4, 1]), _dec107 = type(CCInteger), _dec108 = tooltip('i18n:light_probe.bounces'), _dec109 = range([0.0, 0.05, 0.001]), _dec110 = type(CCFloat), _dec111 = tooltip('i18n:light_probe.reduceRinging'), _dec112 = tooltip('i18n:light_probe.showProbe'), _dec113 = tooltip('i18n:light_probe.showWireframe'), _dec114 = tooltip('i18n:light_probe.showConvex'), _dec97(_class16 = (_class17 = /*#__PURE__*/function () {
        ...
        _proto6.onProbeBakeFinished = function onProbeBakeFinished() {
          this.onProbeBakingChanged(this._scene);
        };

        _proto6.onProbeBakeCleared = function onProbeBakeCleared() {
          this.clearSHCoefficients();
          this.onProbeBakingChanged(this._scene);
        };

        _proto6.onProbeBakingChanged = function onProbeBakingChanged(node) {
          if (!node) {
            return;
          }
      ...
      _export("SceneGlobals", SceneGlobals = (_dec115 = ccclass('cc.SceneGlobals'), _dec116 = type(SkyboxInfo), _dec115(_class19 = (_class20 = /*#__PURE__*/function () {
