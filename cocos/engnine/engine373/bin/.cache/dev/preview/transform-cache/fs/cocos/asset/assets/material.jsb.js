System.register("q-bundled:///fs/cocos/asset/assets/material.jsb.js", ["./effect-asset.js", "../../gfx/index.js", "./texture-base.js", "../../core/index.js", "../../core/data/decorators/index.js", "./asset.js"], function (_export, _context) {
  "use strict";

  var EffectAsset, Texture, TextureBase, Color, Mat3, Mat4, Quat, Vec2, Vec3, Vec4, cclegacy, type, serializable, ccclass, matProto, MathType, Material, materialProto, oldOnLoaded, MaterialProto;
  ...
  return {
    ...
    execute: function () {
      ...
      MaterialProto = Material.prototype; // @ts-expect-error

      type(EffectAsset)(MaterialProto, '_effectAsset', function () {
        return null;
      });
      serializable(MaterialProto, '_techIdx', function () {
        return 0;
      });
      serializable(MaterialProto, '_defines', function () {
        return [];
      });
      serializable(MaterialProto, '_states', function () {
        return [];
      });
      serializable(MaterialProto, '_props', function () {
        return [];
      });
