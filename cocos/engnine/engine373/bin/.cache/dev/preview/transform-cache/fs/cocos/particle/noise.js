    ...
    execute: function () {
      ...
      _export("ParticleNoise", ParticleNoise = /*#__PURE__*/function () {
        ...
        _proto.noise = function noise(x, y, z, min, max) {
          ...
          var val = this.scale(this.lerp(w, this.lerp(v, this.lerp(u, this.grad(p[AA], x, y, z), // AND ADD
        ...
        _proto.getNoiseParticle = function getNoiseParticle() {
          ...
          var axisOffset = 1000.0; // eslint-disable-next-line max-len

          var sampX = this.getNoise(this.point.z + this.accSpeed.x, this.point.y, this.point.x, this.dt, this.accSpeed, this.noiseFrequency, this.octaves); // eslint-disable-next-line max-len

          var sampY = this.getNoise(this.point.x + axisOffset, this.point.z + this.accSpeed.y, this.point.y, this.dt, this.accSpeed, this.noiseFrequency, this.octaves); // eslint-disable-next-line max-len
