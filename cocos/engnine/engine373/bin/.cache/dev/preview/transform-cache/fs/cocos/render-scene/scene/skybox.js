    ...
    execute: function () {
      ...
      _export("Skybox", Skybox = /*#__PURE__*/function () {
        ...
        _proto.activate = function activate() {
          ...
          if (!this._model) {
            this._model = cclegacy.director.root.createModel(cclegacy.renderer.scene.Model); //The skybox material has added properties of 'environmentMap' that need local ubo
