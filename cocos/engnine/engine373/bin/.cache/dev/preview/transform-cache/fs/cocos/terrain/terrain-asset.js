System.register("q-bundled:///fs/cocos/terrain/terrain-asset.js", ["../core/data/decorators/index.js", "../asset/assets/index.js"], function (_export, _context) {
  ...
  var ccclass, serializable, Asset, _dec, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, _initializer5, _initializer6, _dec2, _class4, _dec3, _class6, _class7, _initializer7, TERRAIN_MAX_LEVELS, TERRAIN_MAX_BLEND_LAYERS, TERRAIN_MAX_LAYER_COUNT, TERRAIN_BLOCK_TILE_COMPLEXITY, TERRAIN_BLOCK_VERTEX_COMPLEXITY, TERRAIN_BLOCK_VERTEX_SIZE, TERRAIN_HEIGHT_BASE, TERRAIN_HEIGHT_FACTORY, TERRAIN_HEIGHT_FMIN, TERRAIN_HEIGHT_FMAX, TERRAIN_NORTH_INDEX, TERRAIN_SOUTH_INDEX, TERRAIN_WEST_INDEX, TERRAIN_EAST_INDEX, TERRAIN_DATA_VERSION, TERRAIN_DATA_VERSION2, TERRAIN_DATA_VERSION3, TERRAIN_DATA_VERSION4, TERRAIN_DATA_VERSION5, TERRAIN_DATA_VERSION6, TERRAIN_DATA_VERSION7, TERRAIN_DATA_VERSION_DEFAULT, TerrainBuffer, TerrainLayerInfo, TerrainLayerBinaryInfo, TerrainAsset;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("TerrainLayerInfo", TerrainLayerInfo = (_dec = ccclass('cc.TerrainLayerInfo'), _dec(_class = (_class2 = function TerrainLayerInfo() {
      ...
      }, (_initializer = _applyDecoratedInitializer(_class2.prototype, "slot", [serializable], function () {
        return 0;
      }), _initializer2 = _applyDecoratedInitializer(_class2.prototype, "tileSize", [serializable], function () {
        return 1;
      }), _initializer3 = _applyDecoratedInitializer(_class2.prototype, "detailMap", [serializable], function () {
        return null;
      }), _initializer4 = _applyDecoratedInitializer(_class2.prototype, "normalMap", [serializable], function () {
        return null;
      }), _initializer5 = _applyDecoratedInitializer(_class2.prototype, "roughness", [serializable], function () {
        return 1;
      }), _initializer6 = _applyDecoratedInitializer(_class2.prototype, "metallic", [serializable], function () {
        return 0;
      })), _class2)) || _class));
      /**
      ...
      _export("TerrainLayerBinaryInfo", TerrainLayerBinaryInfo = (_dec2 = ccclass('cc.TerrainLayerBinaryInfo'), _dec2(_class4 = function TerrainLayerBinaryInfo() {
        this.slot = 0;
        this.tileSize = 1;
        this.roughness = 1;
        this.metallic = 0;
      ...
      _export("TerrainAsset", TerrainAsset = (_dec3 = ccclass('cc.TerrainAsset'), _dec3(_class6 = (_class7 = /*#__PURE__*/function (_Asset) {
        ...
        _proto2._exportNativeData = function _exportNativeData() {
          ...
          stream.writeInt32(TERRAIN_DATA_VERSION7); // geometry info
        ...
        return TerrainAsset;
      }(Asset), (_initializer7 = _applyDecoratedInitializer(_class7.prototype, "_layerInfos", [serializable], function () {
        return [];
      })), _class7)) || _class6));
    }
  };
