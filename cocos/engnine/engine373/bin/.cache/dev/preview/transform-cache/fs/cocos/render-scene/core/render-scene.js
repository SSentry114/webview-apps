    ...
    execute: function () {
      ...
      LodStateCache = /*#__PURE__*/function () {
        ...
        _proto2.updateLodState = function updateLodState() {
          ...
          this._newAddedLodGroupVec.length = 0; // update current visible lod index & model's visible cameras list
          ...
          var _loop = function _loop() {
            ...
            if (lodGroup.enabled) {
              ...
              var count = lodLevels.length; // count > 0, indicating that the user force to use certain layers of
              // lod
                ...
                if (lodGroup.isLockLevelChanged()) {
                  ...
                  if (_lodModels2) {
                    ...
                    for (var _iterator13 = _createForOfIteratorHelperLoose(lodLevels), _step13; !(_step13 = _iterator13()).done;) {
                      ...
                      var vecModels = _lodModels2.get(visibleIndex);
              ...
              for (var _iterator15 = _createForOfIteratorHelperLoose(_this._lodStateInCamera), _step15; !(_step15 = _iterator15()).done;) {
                ...
                var lodChangeFlags = lodGroup.node.hasChangedFlags; // Changes in the camera matrix or changes in the matrix of the node
              ...
              if (lodGroup.isLockLevelChanged()) {
                ...
                _this._lodStateInCamera.forEach(function (lodState, camera) {
                  ...
                  if (lodInfo && lodInfo.usedLevel !== lodInfo.lastUsedLevel) {
                    var _vecModels = _lodModels.get(lodInfo.lastUsedLevel);
              ...
              if (hasUpdated) {
                _this._lodStateInCamera.forEach(function (lodState, camera) {
                  ...
                  if (lodInfo) {
                    ...
                    var _vecModels2 = _lodModels.get(usedLevel);
