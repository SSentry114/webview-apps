System.register("q-bundled:///fs/cocos/rendering/deferred/deferred-pipeline.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../asset/asset-manager/builtin-res-mgr.js", "../render-pipeline.js", "./main-flow.js", "../pipeline-serialization.js", "../shadow/shadow-flow.js", "../../gfx/index.js", "../define.js", "../../core/platform/debug.js", "./deferred-pipeline-scene-data.js", "../pipeline-event.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("DeferredPipeline", DeferredPipeline = (_dec = ccclass('DeferredPipeline'), _dec2 = type([RenderTextureConfig]), _dec3 = displayOrder(2), _dec(_class = (_class2 = /*#__PURE__*/function (_RenderPipeline) {
        ...
        _proto._generateDeferredRenderData = function _generateDeferredRenderData() {
          ...
          for (var i = 0; i < 3; ++i) {
            data.gbufferRenderTargets.push(device.createTexture(new TextureInfo(TextureType.TEX2D, TextureUsageBit.COLOR_ATTACHMENT | TextureUsageBit.SAMPLED, Format.RGBA16F, // normals need more precision
          ...
          data.sampler = this.globalDSManager.pointSampler; // Listens when the attachment texture is scaled
