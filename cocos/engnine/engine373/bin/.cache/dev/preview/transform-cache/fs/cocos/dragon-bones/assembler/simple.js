System.register("q-bundled:///fs/cocos/dragon-bones/assembler/simple.js", ["../../core/index.js", "../../gfx/index.js", "../../2d/renderer/vertex-format.js", "../../2d/renderer/static-vb-accessor.js", "../../2d/renderer/render-data.js", "../../game/index.js"], function (_export, _context) {
  ...
  function realTimeTraverse(armature, parentOpacity, worldMat) {
    ...
    for (var i = 0, l = slots.length; i < l; i++) {
      ...
      if (_mustFlush || material.hash !== _currentMaterial.hash || texture && _currentTexture !== texture) {
        ...
        var _cumulatedCount = _indexOffset - _prevDrawIndexOffset; // Submit draw data
      ...
      _indexCount = indices.length; // Slot and vertices in armature may be replaced in some cases
  ...
  function cacheTraverse(frame, parentMat) {
    ...
    var material = null; // let offsetInfo;
    ...
    for (var i = 0, n = segments.length; i < n; i++) {
      ...
      if (_mustFlush || material.hash !== _currentMaterial.hash || segInfo.tex && segInfo.tex !== _currentTexture) {
        ...
        var _cumulatedCount2 = _indexOffset - _prevDrawIndexOffset; // Submit draw data
  ...
  function updateComponentRenderData(comp, batcher) {
    ...
    if (!armature || comp.renderData === null) return; // Init temp var.

    _mustFlush = true;
    _premultipliedAlpha = comp.premultipliedAlpha; // Reuse draw list
    ...
    _accessor.getMeshBuffer(_renderData.chunk.bufferId).setDirty(); // Clear temp var.
      ...
      _export("simple", simple = {
        ...
        ensureAccessor: function ensureAccessor() {
          if (!_accessor) {
            ...
            this.accessor = _accessor = new StaticVBAccessor(device, attributes, this.vCount); // Register to batcher so that batcher can upload buffers after batching process
