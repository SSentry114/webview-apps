System.register("q-bundled:///fs/cocos/particle/animator/curve-range.js", ["../../core/data/decorators/index.js", "../../../../virtual/internal%253Aconstants.js", "../../core/index.js", "../../asset/assets/asset-enum.js", "../../asset/assets/index.js"], function (_export, _context) {
  "use strict";

  var ccclass, EDITOR, lerp, RealCurve, CCClass, geometry, Enum, approx, EPSILON, PixelFormat, Filter, WrapMode, Texture2D, ImageAsset, _dec, _class, _class2, _temp, setClassAttr, SerializableTable, Mode, CurveRange;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", CurveRange = (_dec = ccclass('cc.CurveRange'), _dec(_class = (_temp = _class2 = /*#__PURE__*/function () {
        function CurveRange() {
          this.constant = 0;
          this.constantMin = 0;
          this.constantMax = 0;
        ...
        return CurveRange;
      }(), _class2.Mode = Mode, _temp)) || _class));
