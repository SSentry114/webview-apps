  ...
  return {
    ...
    execute: function () {
      ...
      PrePrintVisitor = /*#__PURE__*/function () {
        ...
        _proto.clear = function clear(value) {// do nothing
        };

        _proto.viewport = function viewport(value) {// do nothing
        };
      ...
      PostPrintVisitor = /*#__PURE__*/function () {
        ...
        _proto2.clear = function clear(value) {// do nothing
        };

        _proto2.viewport = function viewport(value) {// do nothing
        };

        _proto2.rasterPass = function rasterPass(value) {// post raster pass
        };
        ...
        _proto2.queue = function queue(value) {// collect scene results
        };

        _proto2.scene = function scene(value) {// scene command list finished
        };
      ...
      _export("RenderGraphPrintVisitor", RenderGraphPrintVisitor = /*#__PURE__*/function (_DefaultVisitor) {
        ...
        _proto3.initializeVertex = function initializeVertex(v, gv) {// initialization
        };

        _proto3.startVertex = function startVertex(v, gv) {
          var g = gv.g; // passes begin
