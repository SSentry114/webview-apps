System.register("q-bundled:///fs/cocos/2d/assets/bitmap-font.js", ["../../core/data/decorators/index.js", "./font.js", "./sprite-frame.js", "../../core/index.js"], function (_export, _context) {
  ...
  var ccclass, type, serializable, editable, Font, SpriteFrame, cclegacy, js, warn, _dec, _dec2, _class, _class2, _initializer, _initializer2, _initializer3, _initializer4, FontLetterDefinition, FontAtlas, BitmapFont;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("BitmapFont", BitmapFont = (_dec = ccclass('cc.BitmapFont'), _dec2 = type(SpriteFrame), _dec(_class = (_class2 = /*#__PURE__*/function (_Font) {
        ...
        _proto2.clearVerticalKeningDict = function clearVerticalKeningDict() {
          var fntConfig = this.fntConfig;
        ...
        _proto2.setVerticalKerningDict = function setVerticalKerningDict(kerningDict) {
          var fntConfig = this.fntConfig;
          ...
          if (!kerningDict) {// example data for thai font
            ...
            var dict = {};
            kerningDict.forEach(function (js) {
              if (js) {
                dict[js.first << 16 | js.second & 0xffff] = js.amount;
              }
            });
        ...
        return BitmapFont;
      }(Font), (_initializer = _applyDecoratedInitializer(_class2.prototype, "fntDataStr", [serializable, editable], function () {
        return '';
