System.register("q-bundled:///fs/cocos/asset/asset-manager/downloader.js", ["../../../../virtual/internal%253Aconstants.js", "../../core/index.js", "./cache.js", "./download-dom-image.js", "./download-file.js", "./download-script.js", "./shared.js", "./utilities.js", "../../serialization/ccon.js", "../../core/global-exports.js"], function (_export, _context) {
  "use strict";

  var BUILD, EDITOR, sys, js, misc, path, cclegacy, Cache, downloadDomImage, downloadFile, downloadScript, files, retry, urlAppendTimestamp, CCON, parseCCONJson, decodeCCONBinary, legacyCC, REGEX, downloadImage, downloadBlob, downloadJson, downloadArrayBuffer, downloadCCON, downloadCCONB, downloadText, downloadBundle, Downloader, downloader;
    ...
    execute: function () {
      ...
      _export("Downloader", Downloader = /*#__PURE__*/function () {
        ...
        function Downloader() {
          ...
          this.appendTimeStamp = !!(EDITOR && !legacyCC.GAME_VIEW);
          this.limited = !(EDITOR && !legacyCC.GAME_VIEW);
