  ...
  return {
    ...
    execute: function () {
      ...
      _export("AnimationComponent", _export("Animation", Animation = (_dec = ccclass('cc.Animation'), _dec2 = help('i18n:cc.Animation'), _dec3 = executionOrder(99), _dec4 = menu('Animation/Animation'), _dec5 = type([AnimationClip]), _dec6 = tooltip('i18n:animation.clips'), _dec7 = type(AnimationClip), _dec8 = tooltip('i18n:animation.default_clip'), _dec9 = tooltip('i18n:animation.play_on_load'), _dec10 = type([AnimationClip]), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = _dec4(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Eventify) {
        ...
        return Animation;
      }(Eventify(Component)), _class3.EventType = EventType, _temp), (_applyDecoratedDescriptor(_class2.prototype, "clips", [_dec5, _dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "clips"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "defaultClip", [_dec7, _dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "defaultClip"), _class2.prototype), _initializer = _applyDecoratedInitializer(_class2.prototype, "playOnLoad", [serializable, _dec9], function () {
        return false;
