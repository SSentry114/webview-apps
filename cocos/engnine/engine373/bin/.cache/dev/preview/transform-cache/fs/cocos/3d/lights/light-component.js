System.register("q-bundled:///fs/cocos/3d/lights/light-component.js", ["../../core/data/decorators/index.js", "../../scene-graph/component.js", "../../core/index.js", "../../render-scene/index.js", "../../rendering/define.js", "../../scene-graph/layers.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("Light", Light = (_dec2 = ccclass('cc.Light'), _dec3 = tooltip('i18n:lights.color'), _dec4 = tooltip('i18n:lights.use_color_temperature'), _dec5 = range([1000, 15000, 1]), _dec6 = tooltip('i18n:lights.color_temperature'), _dec7 = type(StaticLightSettings), _dec8 = displayOrder(50), _dec9 = tooltip('i18n:lights.visibility'), _dec10 = displayOrder(255), _dec11 = type(Layers.BitMask), _dec2(_class4 = (_class5 = (_temp = _class6 = /*#__PURE__*/function (_Component) {
        ...
        return Light;
      }(Component), _class6.Type = scene.LightType, _class6.PhotometricTerm = PhotometricTerm, _temp), (_initializer4 = _applyDecoratedInitializer(_class5.prototype, "_color", [serializable], function () {
