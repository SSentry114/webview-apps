    ...
    execute: function () {
      ...
      _export("RichText", RichText = (_dec = ccclass('cc.RichText'), _dec2 = help('i18n:cc.RichText'), _dec3 = executionOrder(110), _dec4 = menu('2D/RichText'), _dec5 = tooltip('i18n:richtext.string'), _dec6 = type(HorizontalTextAlignment), _dec7 = tooltip('i18n:richtext.horizontal_align'), _dec8 = type(VerticalTextAlignment), _dec9 = tooltip('i18n:richtext.vertical_align'), _dec10 = tooltip('i18n:richtext.font_size'), _dec11 = tooltip('i18n:richtext.font_family'), _dec12 = type(Font), _dec13 = tooltip('i18n:richtext.font'), _dec14 = tooltip('i18n:richtext.use_system_font'), _dec15 = displayOrder(12), _dec16 = type(CacheMode), _dec17 = tooltip('i18n:richtext.cache_mode'), _dec18 = tooltip('i18n:richtext.max_width'), _dec19 = tooltip('i18n:richtext.line_height'), _dec20 = type(SpriteAtlas), _dec21 = tooltip('i18n:richtext.image_atlas'), _dec22 = tooltip('i18n:richtext.handleTouchEvent'), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = executeInEditMode(_class = (_class2 = (_temp = _class3 = /*#__PURE__*/function (_Component) {
        ...
        function RichText() {
          ...
          _this._maxWidth = _initializer6 && _initializer6();
          _this._fontFamily = _initializer7 && _initializer7();
          _this._font = _initializer8 && _initializer8();
          _this._isSystemFontUsed = _initializer9 && _initializer9();
          _this._userDefinedFont = _initializer10 && _initializer10();
          _this._cacheMode = _initializer11 && _initializer11();
          _this._imageAtlas = _initializer12 && _initializer12();
          _this._handleTouchEvent = _initializer13 && _initializer13();
          _this._textArray = [];
          _this._segments = [];
        ...
        */
        ...
        _proto.splitLongStringApproximatelyIn2048 = function splitLongStringApproximatelyIn2048(text, styleIndex) {
          ...
          var partStringArr = []; // avoid that many short richtext still execute _calculateSize so that performance is low
        ...
        */
        ...
        _proto.splitLongStringOver2048 = function splitLongStringOver2048(text, styleIndex) {
          ...
          var sizeForOnePart = lineCountForOnePart * maxWidth; // divide text into some pieces of which the size is less than sizeForOnePart
          ...
          var leftTryTimes = 1000; // the minimum step of expansion or reduction

          var curWordStep = 1;

          while (leftTryTimes && curStart < text.length) {
            while (leftTryTimes && curStringSize.x < sizeForOnePart) {
              var nextPartExec = getEnglishWordPartAtFirst(leftString); // add a character, unless there is a complete word at the beginning of the next line
