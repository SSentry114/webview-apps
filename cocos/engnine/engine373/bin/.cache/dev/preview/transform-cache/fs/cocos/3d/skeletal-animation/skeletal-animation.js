System.register("q-bundled:///fs/cocos/3d/skeletal-animation/skeletal-animation.js", ["../../core/data/decorators/index.js", "../skinned-mesh-renderer/index.js", "../../core/index.js", "../../scene-graph/node.js", "../../animation/animation-component.js", "./skeletal-animation-data-hub.js", "./skeletal-animation-state.js", "../../animation/transform-utils.js", "../../animation/global-animation-manager.js"], function (_export, _context) {
  ...
  var ccclass, executeInEditMode, executionOrder, help, menu, tooltip, type, serializable, editable, SkinnedMeshRenderer, Mat4, cclegacy, js, assertIsTrue, Node, Animation, SkelAnimDataHub, SkeletalAnimationState, getWorldTransformUntilRoot, getGlobalAnimationManager, _dec, _dec2, _class, _class2, _initializer, _initializer2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class4, _class5, _initializer3, _initializer4, _class6, _temp, Socket, m4_1, m4_2, SkeletalAnimation;
  ...
  return {
    ...
    execute: function () {
       ...
       */
      _export("Socket", Socket = (_dec = ccclass('cc.SkeletalAnimation.Socket'), _dec2 = type(Node), _dec(_class = (_class2 =
      /**
      ...
      _export("SkeletalAnimation", SkeletalAnimation = (_dec3 = ccclass('cc.SkeletalAnimation'), _dec4 = help('i18n:cc.SkeletalAnimation'), _dec5 = executionOrder(99), _dec6 = menu('Animation/SkeletalAnimation'), _dec7 = type([Socket]), _dec8 = tooltip('i18n:animation.sockets'), _dec9 = tooltip('i18n:animation.use_baked_animation'), _dec10 = type([Socket]), _dec3(_class4 = _dec4(_class4 = _dec5(_class4 = executeInEditMode(_class4 = _dec6(_class4 = (_class5 = (_temp = _class6 = /*#__PURE__*/function (_Animation) {
        ...
        _proto.onLoad = function onLoad() {
          _Animation.prototype.onLoad.call(this); // Actively search for potential users and notify them that an animation is usable.
      ...
      }(Animation), _class6.Socket = Socket, _temp), (_applyDecoratedDescriptor(_class5.prototype, "sockets", [_dec7, _dec8], Object.getOwnPropertyDescriptor(_class5.prototype, "sockets"), _class5.prototype), _applyDecoratedDescriptor(_class5.prototype, "useBakedAnimation", [_dec9], Object.getOwnPropertyDescriptor(_class5.prototype, "useBakedAnimation"), _class5.prototype), _initializer3 = _applyDecoratedInitializer(_class5.prototype, "_useBakedAnimation", [serializable], function () {
        return true;
      }), _initializer4 = _applyDecoratedInitializer(_class5.prototype, "_sockets", [_dec10], function () {
        return [];
