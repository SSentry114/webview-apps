      ...
      _export("WebGL2Device", WebGL2Device = /*#__PURE__*/function (_Device) {
        ...
        _proto.initialize = function initialize(info) {
          ...
          for (var i = 1; i < mapping.setIndices.length; ++i) {
            ...
            var prevSet = mapping.setIndices[i - 1]; // accumulate the per set offset according to the specified capacity
          ...
          for (var _i = 0; _i < mapping.setIndices.length; ++_i) {
            var _curSet = mapping.setIndices[_i]; // textures always come after UBOs
