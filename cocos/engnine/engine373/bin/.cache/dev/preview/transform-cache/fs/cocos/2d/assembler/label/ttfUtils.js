System.register("q-bundled:///fs/cocos/2d/assembler/label/ttfUtils.js", ["../../../../../virtual/internal%253Aconstants.js", "../../assets/index.js", "../../utils/text-utils.js", "../../../core/index.js", "../../components/index.js", "../../utils/dynamic-atlas/atlas-manager.js", "../../../gfx/index.js", "../../../asset/assets/asset-enum.js"], function (_export, _context2) {
  "use strict";

  var JSB, SpriteFrame, fragmentText, safeMeasureText, getBaselineOffset, BASELINE_RATIO, Color, Size, Vec2, Rect, logID, cclegacy, HorizontalTextAlignment, Label, LabelOutline, VerticalTextAlignment, LabelShadow, dynamicAtlasManager, BlendFactor, WrapMode, Overflow, MAX_SIZE, _BASELINE_OFFSET, _invisibleAlpha, _context, _canvas, _texture, _fontDesc, _string, _fontSize, _drawFontsize, _splitStrings, _canvasSize, _lineHeight, _hAlign, _vAlign, _color, _alpha, _fontFamily, _overflow, _isWrapText, _outlineComp, _outlineColor, _shadowComp, _shadowColor, _canvasPadding, _contentSizeExtend, _nodeContentSize, _startPosition, _drawUnderlinePos, _drawUnderlineWidth, _underlineThickness, _isBold, _isItalic, _isUnderline, Alignment, ttfUtils;
      ...
      _export("ttfUtils", ttfUtils = {
        ...
        updateRenderData: function updateRenderData(comp) {
          ...
          if (comp.renderData.vertDirty) {
            ...
            comp.renderData.vertDirty = false; // comp.markForUpdateRenderData(false);
        ...
        _calDynamicAtlas: function _calDynamicAtlas(comp) {
          ...
          var frame = comp.ttfSpriteFrame;
          dynamicAtlasManager.packToDynamicAtlas(comp, frame); // TODO update material and uv
        },
