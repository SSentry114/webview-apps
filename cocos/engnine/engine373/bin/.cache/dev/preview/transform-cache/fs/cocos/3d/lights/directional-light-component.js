System.register("q-bundled:///fs/cocos/3d/lights/directional-light-component.js", ["./light-component.js", "../../render-scene/index.js", "../../core/index.js", "../../render-scene/scene/index.js", "../framework/index.js", "../../game/director.js"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("DirectionalLight", DirectionalLight = (_dec = ccclass('cc.DirectionalLight'), _dec2 = help('i18n:cc.DirectionalLight'), _dec3 = menu('Light/DirectionalLight'), _dec4 = formerlySerializedAs('_illuminance'), _dec5 = tooltip('i18n:lights.illuminance'), _dec6 = tooltip('i18n:lights.shadowEnabled'), _dec7 = visible(function () {
      ...
      }), _dec9 = type(CCBoolean), _dec10 = tooltip('i18n:lights.shadowPcf'), _dec11 = visible(function () {
        return cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap;
      }), _dec12 = property({
        group: {
          name: 'DynamicShadowSettings',
      ...
      }), _dec13 = type(PCFType), _dec14 = tooltip('i18n:lights.shadowBias'), _dec15 = visible(function () {
        return cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap;
      }), _dec16 = property({
        group: {
          name: 'DynamicShadowSettings',
      ...
      }), _dec17 = type(CCFloat), _dec18 = tooltip('i18n:lights.shadowNormalBias'), _dec19 = visible(function () {
        return cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap;
      }), _dec20 = property({
        group: {
          name: 'DynamicShadowSettings',
      ...
      }), _dec21 = type(CCFloat), _dec22 = tooltip('i18n:lights.shadowSaturation'), _dec23 = visible(function () {
        return cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap;
      }), _dec24 = property({
        group: {
          name: 'DynamicShadowSettings',
      ...
      }), _dec55 = tooltip('CSM Performance Optimization Mode'), _dec56 = type(CSMOptimizationMode), _dec57 = tooltip('i18n:lights.shadowFixedArea'), _dec58 = visible(function () {
        return cclegacy.director.root.pipeline.pipelineSceneData.shadows.enabled && cclegacy.director.root.pipeline.pipelineSceneData.shadows.type === ShadowType.ShadowMap;
      }), _dec59 = property({
        group: {
          name: 'DynamicShadowSettings',
      ...
      }), _dec84 = range([0.0, 0.1, 0.01]), _dec85 = type(CCFloat), _dec(_class = _dec2(_class = _dec3(_class = executeInEditMode(_class = (_class2 = /*#__PURE__*/function (_Light) {
        ...
        _createClass(DirectionalLight, [{
          key: "illuminance",
          get: // Public properties of shadow
