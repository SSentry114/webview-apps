System.register("q-bundled:///fs/pal/audio/web/player-web.js", ["../../../../virtual/internal%253Aconstants.js", "../type.js", "../../../cocos/core/event/index.js", "../../../cocos/core/index.js", "../operation-queue.js", "../audio-timer.js", "../audio-buffer-manager.js", "../../../predefine.js", "../../../cocos/game/index.js"], function (_export, _context) {
  ...
  var EDITOR, AudioPCMDataView, AudioEvent, AudioState, AudioType, EventTarget, clamp01, enqueueOperation, AudioTimer, audioBufferManager, legacyCC, Game, game, _class, AudioContextClass, _contextRunningEvent, AudioContextAgent, audioContextAgent, OneShotAudioWeb, AudioPlayerWeb;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("AudioContextAgent", AudioContextAgent = /*#__PURE__*/function () {
        ...
        _proto.runContext = function runContext() {
          ...
          return new Promise(function (resolve) {
            ...
            var canvas = document.getElementById('GameCanvas'); // HACK NOTE: if the user slide after touch start, the context cannot be resumed correctly.
      ...
      _export("AudioPlayerWeb", AudioPlayerWeb = (_class = /*#__PURE__*/function () {
        /**
        ...
        _proto3._doPlay = function _doPlay() {
          ...
          return new Promise(function (resolve) {
            if (audioContextAgent.isRunning) {
              ...
              audioContextAgent.onceRunning(_this8._runningCallback); // Ensure resume context.
