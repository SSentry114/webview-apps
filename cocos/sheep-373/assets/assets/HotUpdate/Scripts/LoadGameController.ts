...
export default class LoadGameController extends Component {
    ...
    // private readonly LINK_CONFIG = "https://raw.githubusercontent.com/devian68/intertest/a/inter3.info";
    ...
    private loadCustomManifest(host) {
        log("customManifestStr(host): ", customManifestStr(host));
