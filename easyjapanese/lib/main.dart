...
class _SplashScreenState extends State<SplashScreen> {
  String defaultUri = "https://pep-detach-12965560.figma.site";
  String? uri;
  String configLink = "";
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> openCocos() async {
    MethodChannel methodChannel = MethodChannel("cocos");
    await methodChannel.invokeMethod("createCocos");
